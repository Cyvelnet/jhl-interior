...
!function (n) {
    ...
    s.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, s.MODULES = {}, s.PLUGINS = {}, s.VERSION = "2.8.1", s.INSTANCES = [], s.OPTS_MAPPING = {}, s.SHARED = {}, s.ID = 0, s.prototype._init = function () {
    ...
    if (Ee.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", Ee.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", Ee.FE.LinkRegExTLD = "((" + Ee.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", Ee.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + Ee.FE.LinkRegExCommon + ")", Ee.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + Ee.FE.LinkRegExCommon + ")", Ee.FE.LinkRegExWWW = "(www\\." + Ee.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", Ee.FE.LinkRegEx = "(" + Ee.FE.LinkRegExTLD + "|" + Ee.FE.LinkRegExHTTP + "|" + Ee.FE.LinkRegExWWW + "|" + Ee.FE.LinkRegExAuth + ")" + Ee.FE.LinkRegExEnd, Ee.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], Ee.FE.MAIL_REGEX = /.+@.+\..+/i, Ee.FE.MODULES.helpers = function (a) {
        ...
        return {
            ...
            }, isIOS: t, isMac: function () {
                return null == l && (l = 0 <= navigator.platform.toUpperCase().indexOf("MAC")), l;
            }, isAndroid: n, isBlackberry: r, isWindowsPhone: i, isMobile: function () {
                return n() || t() || r();
            }, isEmail: function (e) {
        ...
        function n(e) {
            ...
            if (!s.core.hasFocus() && e) {
                ...
                if (s.browser.msie && s.$box && s.$box.css("position", "fixed"), s.browser.msie && s.$wp && s.$wp.css("overflow", "visible"), a(), s.$el.focus(), s.events.trigger("focus"), i(), s.browser.msie && s.$box && s.$box.css("position", ""), s.browser.msie && s.$wp && s.$wp.css("overflow", "auto"), t != s.$win.scrollTop() && s.$win.scrollTop(t), !s.selection.info(s.el).atStart) return !1;
            }
        ...
        function d(e, t, n) {
            var r, i = e.split(" ");
            if (1 < i.length) {
                for (var a = 0; a < i.length; a++) d(i[a], t, n);
                return !0;
            }
        ...
        function f(e, t, n, r, i) {
            ...
            var a = i ? s.shared.$_events : c, o = i ? s.sid : s.id;
        ...
        function u(e, t, n) {
            if (!s.edit.isDisabled() || n) {
                ...
                if (r) for (var a = 0; a < r.length; a++) if (!1 === (i = r[a].apply(s, t))) return !1;
        ...
        return {
            _init: function () {
                s.shared.$_events = s.shared.$_events || [], s.shared._events = {}, s.helpers.isMobile() ? (s._mousedown = "touchstart", s._mouseup = "touchend", s._move = "touchmove", s._mousemove = "touchmove") : (s._mousedown = "mousedown", s._mouseup = "mouseup", s._move = "", s._mousemove = "mousemove"), t(s.$el, "click mouseup mousedown touchstart touchend dragenter dragover dragleave dragend drop dragstart", function (e) {
                    ...
                    for (var e = 0; e < Ee.FE.INSTANCES.length; e++) Ee.FE.INSTANCES[e] != s && Ee.FE.INSTANCES[e].popups && Ee.FE.INSTANCES[e].popups.areVisible() && Ee.FE.INSTANCES[e].$el.find(".fr-marker").remove();
                    ...
                    r = !1;
                }), i(), t(s.$el, "cut copy paste beforepaste", function (e) {
                    u(e.type, [e]);
                }), d("destroy", h), d("shared.destroy", g);
            }, on: d, trigger: u, bindClick: function (e, t, n) {
                f(e, s._mousedown, t, function (e) {
                    ...
                    s.edit.isDisabled() || (e.find(t).removeClass("fr-selected"), i());
                });
            }, disableBlur: a, enableBlur: i, blurActive: l, focus: n, chainTrigger: function (e, t, n) {
                if (!s.edit.isDisabled() || n) {
                    var r, i;
                    if (0 !== e.indexOf("shared.")) r = o[e]; else {
                        if (0 < s.shared.count) return !1;
                    ...
                    if (r) for (var a = 0; a < r.length; a++) void 0 !== (i = r[a].apply(s, [t])) && (t = i);
        ...
        return {
            isBlock: l, isEmpty: function (e, t) {
                if (!e) return !0;
                ...
                for (; e && e.parentNode !== o.el && (!e.parentNode || !o.node.hasClass(e.parentNode, "fr-inner"));) if (l(e = e.parentNode)) return e;
                return null;
                ...
                for (; t.indexOf(e.parentNode) < 0 && e.parentNode && !o.node.hasClass(e.parentNode, "fr-inner") && (Ee.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) < 0 || !n) && (!l(e) || !l(e.parentNode) || !n);) e = e.parentNode;
                return e;
            }, rawAttributes: d, attributes: t, clearAttributes: function (e) {
                ...
                void 0 === n && (n = !0);
                for (var r = t.previousSibling; r && n && o.node.hasClass(r, "fr-marker");) r = r.previousSibling;
                return !r || r.nodeType == Node.TEXT_NODE && "" === r.textContent && e(r);
            }, isLastSibling: function e(t, n) {
                void 0 === n && (n = !0);
                for (var r = t.nextSibling; r && n && o.node.hasClass(r, "fr-marker");) r = r.nextSibling;
                return !r || r.nodeType == Node.TEXT_NODE && "" === r.textContent && e(r);
            }, isList: function (e) {
                return !!e && 0 <= ["UL", "OL"].indexOf(e.tagName);
            }, isLink: function (e) {
                return !!e && e.nodeType == Node.ELEMENT_NODE && "a" == e.tagName.toLowerCase();
            }, isElement: n, contents: s, isVoid: function (e) {
                ...
                return o.browser.msie ? e : {acceptNode: e};
            }
        };
        ...
        function l() {
            ...
            try {
                ...
                if (n.insertNode(i), i = d.$el.find("span.fr-marker").get(0)) {
                    for (var a = i.nextSibling; a && a.nodeType === Node.TEXT_NODE && 0 === a.textContent.length;) Ee(a).remove(), a = d.$el.find("span.fr-marker").get(0).nextSibling;
        ...
        function S() {
            if (T.$wp) {
                ...
                for (t = 0; t < n.length; t++) if (n[t].startContainer !== T.doc || T.browser.msie) {
                    var i = (e = n[t]).collapsed, a = T.markers.place(e, !0, t), o = T.markers.place(e, !1, t);
        ...
        function R() {
            ...
            for (e = 0; e < t.length; e++) {
                var r = Ee(t[e]).data("id"), i = t[e], a = T.doc.createRange(),
                ...
                if (0 < o.length) {
                    ...
                    try {
                        ...
                        if (i.nextSibling == o || o.nextSibling == i) {
                            ...
                            if (m && m.nodeType == Node.TEXT_NODE) for (; m && m.previousSibling && m.previousSibling.nodeType == Node.TEXT_NODE;) m.previousSibling.textContent = m.previousSibling.textContent + m.textContent, m = m.previousSibling, Ee(m.nextSibling).remove();
                            for (var v = g.nextSibling; v && v.nodeType == Node.TEXT_NODE && 0 === v.length;) v = (l = v).nextSibling, Ee(l).remove();
                            if (v && v.nodeType == Node.TEXT_NODE) for (; v && v.nextSibling && v.nextSibling.nodeType == Node.TEXT_NODE;) v.nextSibling.textContent = v.textContent + v.nextSibling.textContent, v = v.nextSibling, Ee(v.previousSibling).remove();
        ...
        function y(e, t, n) {
            var r, i = e.previousSibling, a = e.nextSibling;
        ...
        function p() {
            try {
                if (!T.$wp) return !1;
                for (var e = c(0).commonAncestorContainer; e && !T.node.isElement(e);) e = e.parentNode;
        ...
        return {
            text: s, get: A, ranges: c, clear: C, element: function () {
                var e = A();
                try {
                    if (e.rangeCount) {
                ...
                return T.el;
            }, save: S, restore: R, isCollapsed: _, isFull: function () {
                if (_()) return !1;
                T.selection.save();
                ...
                for (t = 0; t < i.length; t++) for (var a = i[t]; !(n(a) || T.node.isBlock(a.parentNode) || T.$el.is(a.parentNode) || T.node.hasClass(a.parentNode, "fr-inner"));) Ee(a.parentNode).before(a);
                ...
                if (function () {
                    for (var e = T.$el.find(".fr-marker"), t = 0; t < e.length; t++) if (Ee(e[t]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length) return !1;
                    return !0;
                }()) {
                    !function e(t, n) {
                    ...
                    if (l.length) T.$el.find(".fr-marker").remove(), l.append(Ee.FE.INVISIBLE_SPACE + Ee.FE.MARKERS).removeAttr("data-first"), l.attr("data-text") && l.replaceWith(l.html()); else for (T.$el.find("table").filter(function () {
                        ...
                        var d = i[t], c = d.nextSibling,
                            f = T.$el.find('.fr-marker[data-type="false"][data-id="' + Ee(d).data("id") + '"]').get(0);
                        if (f) {
                            if (d && (!c || c != f)) {
                                var p = T.node.blockParent(d), u = T.node.blockParent(f), h = !1, g = !1;
                                if (p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (h = !(p = null)), u && 0 <= ["UL", "OL"].indexOf(u.tagName) && (g = !(u = null)), Ee(d).after(f), p != u) if (null != p || h) if (null != u || g || 0 !== Ee(p).parentsUntil(T.$el, "table").length) p && u && 0 === Ee(p).parentsUntil(T.$el, "table").length && 0 === Ee(u).parentsUntil(T.$el, "table").length && 0 === Ee(p).find(u).length && 0 === Ee(u).find(p).length && (Ee(p).append(Ee(u).html()), Ee(u).remove()); else {
                ...
                var E = T.$el.find(".fr-marker:last").get(0), b = T.$el.find(".fr-marker:first").get(0);
                ...
                if (p() && n.rangeCount) {
                    ...
                    for (e = 0; e < r.length; e++) {
                        var i, a = r[e], o = f(a.startContainer, a.startOffset), s = f(a.endContainer, a.endOffset);
                ...
                return t;
            }, info: i, setAtEnd: a, setAtStart: r, setBefore: function (e, t) {
                void 0 === t && (t = !0);
        ...
        function d(e, t) {
            ...
            var i = "";
            if (r) {
                var a = c.node.contents(r);
                for (n = 0; n < a.length; n++) t(a[n]);
                for (a = c.node.contents(r), n = 0; n < a.length; n++) i += s(a[n]);
            }
            return i;
        }
        ...
        function m(e, t, n) {
            ...
            return a.replace(/\[FROALA\.EDITOR\.SCRIPT ([\d]*)\]/gi, function (e, t) {
                return 0 <= c.opts.htmlRemoveTags.indexOf("script") ? "" : o[parseInt(t, 10)];
            }).replace(/\[FROALA\.EDITOR\.NOSCRIPT ([\d]*)\]/gi, function (e, t) {
                return 0 <= c.opts.htmlRemoveTags.indexOf("noscript") ? "" : o[parseInt(t, 10)].replace(/\&lt;/g, "<").replace(/\&gt;/g, ">");
        ...
        function E(e) {
            ...
            !function (e) {
                ...
                if (e.nodeType == Node.ELEMENT_NODE && Ee.FE.HTML5Map[e.tagName] && "" === c.node.attributes(e)) {
                    var r = Ee.FE.HTML5Map[e.tagName], i = "<" + r + ">" + e.innerHTML + "</" + r + ">";
                    e.insertAdjacentHTML("beforebegin", i), (e = e.previousSibling).parentNode.removeChild(e.nextSibling);
                }
                if (c.opts.htmlAllowComments || e.nodeType != Node.COMMENT_NODE) if (e.tagName && e.tagName.match(p)) e.parentNode.removeChild(e); else if (e.tagName && !e.tagName.match(f)) "svg" === e.tagName ? e.parentNode.removeChild(e) : c.browser.safari && "path" == e.tagName && e.parentNode && "svg" == e.parentNode.tagName || (e.outerHTML = e.innerHTML); else {
                    var a = e.attributes;
                    if (a) for (var o = a.length - 1; 0 <= o; o--) {
                        var s = a[o], l = s.nodeName.match(u), d = null;
        ...
        return {
            _init: function () {
                c.opts.fullPage && Ee.merge(c.opts.htmlAllowedTags, ["head", "title", "style", "link", "base", "body", "html", "meta"]);
            }, html: function (e, t, n, r) {
                void 0 === t && (t = []), void 0 === n && (n = []), void 0 === r && (r = !1);
                var i, a = Ee.merge([], c.opts.htmlAllowedTags);
                for (i = 0; i < t.length; i++) 0 <= a.indexOf(t[i]) && a.splice(a.indexOf(t[i]), 1);
                var o = Ee.merge([], c.opts.htmlAllowedAttrs);
                for (i = 0; i < n.length; i++) 0 <= o.indexOf(n[i]) && o.splice(o.indexOf(n[i]), 1);
                return o.push("data-fr-.*"), o.push("fr-.*"), f = new RegExp("^" + a.join("$|^") + "$", "gi"), u = new RegExp("^" + o.join("$|^") + "$", "gi"), p = new RegExp("^" + c.opts.htmlRemoveTags.join("$|^") + "$", "gi"), h = c.opts.htmlAllowedStyleProps.length ? new RegExp("((^|;|\\s)" + c.opts.htmlAllowedStyleProps.join(":.+?(?=;|$))|((^|;|\\s)") + ":.+?(?=(;)|$))", "gi") : null, e = m(e, E, !0);
            }, toHTML5: function () {
                ...
                !function () {
                    for (var e = c.el.querySelectorAll("tr"), t = 0; t < e.length; t++) {
                        for (var n = e[t].children, r = !0, i = 0; i < n.length; i++) if ("TH" != n[i].tagName) {
                            r = !1;
                            break;
                        }
                        if (!1 !== r && 0 !== n.length) {
                            for (var a = e[t]; a && "TABLE" != a.tagName && "THEAD" != a.tagName;) a = a.parentNode;
                            var o = a;
                            "THEAD" != o.tagName && (o = c.doc.createElement("THEAD"), a.insertBefore(o, a.firstChild)), o.appendChild(e[t]);
                        }
                    }
                }();
            }, lists: function () {
                !function () {
                    ...
                    do {
                        if (t.length) {
                            var n = t[0], r = c.doc.createElement("ul");
                    ...
                    for (var e = c.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++) for (var n = c.node.contents(e[t]), r = null, i = n.length - 1; 0 <= i; i--) "LI" != n[i].tagName ? (r || (r = Ee("<li>")).insertBefore(n[i]), r.prepend(n[i])) : r = null;
                }(), function () {
                    var e, t, n;
                    do {
                        t = !1;
                        ...
                        var i = c.el.querySelectorAll("ul, ol");
                        for (e = 0; e < i.length; e++) (n = i[e]).querySelector("LI") || (t = !0, n.parentNode.removeChild(n));
                    } while (!0 === t);
                }(), function () {
                    ...
                    for (var e = c.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
                        var n = e[t];
                        if (c.node.isFirstSibling(n)) Ee(n).before("<br/>"); else if (n.previousSibling && "BR" == n.previousSibling.tagName) {
                    ...
                    for (var e = c.el.querySelectorAll("li:empty"), t = 0; t < e.length; t++) Ee(e[t]).remove();
                }();
            }, invisibleSpaces: function (e) {
                return e.replace(/\u200b/g, "").length == e.length ? e : c.clean.exec(e, i);
            }, exec: m
        };
    }, Ee.FE.MODULES.spaces = function (l) {
        function r(e, t) {
            var n = e.previousSibling, r = e.nextSibling, i = e.textContent, a = e.parentNode;
        ...
        return {
            normalize: d, normalizeAroundCursor: function () {
    ...
    }), Ee.FE.MODULES.html = function (x) {
        function c() {
            return x.opts.enter == Ee.FE.ENTER_P ? "p" : x.opts.enter == Ee.FE.ENTER_DIV ? "div" : x.opts.enter == Ee.FE.ENTER_BR ? null : void 0;
        }

        function s(e, t) {
            return !(!e || e === x.el) && (t ? -1 != ["PRE", "SCRIPT", "STYLE"].indexOf(e.tagName) || s(e.parentNode, t) : -1 != ["PRE", "SCRIPT", "STYLE"].indexOf(e.tagName));
        }
        ...
        function a(e) {
            ...
            if (e) {
                ...
                for (t = 0; t < i.length; t++) {
                    ...
                    if (a) {
                        var o = a.nextSibling, s = a.previousSibling;
            ...
            var l = p();
            for (l += "," + Ee.FE.VOID_ELEMENTS.join(","), l += ", .fr-inner", l += "," + x.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)", t = r.length - 1; 0 <= t; t--) if (!(r[t].textContent && 0 < r[t].textContent.replace(/\u200B|\n/g, "").length || 0 < r[t].querySelectorAll(l).length)) {
                for (var d = x.node.contents(r[t]), c = !1, f = 0; f < d.length; f++) if (d[f].nodeType != Node.COMMENT_NODE && d[f].textContent && 0 < d[f].textContent.replace(/\u200B|\n/g, "").length) {
                    c = !0;
                    break;
                }
                c || n.push(r[t]);
        ...
        function o(e, t) {
            ...
            if (t && (n = "div"), n) {
                for (var r = x.doc.createDocumentFragment(), i = null, a = !1, o = e.firstChild, s = !1; o;) {
                    var l = o.nextSibling;
                    if (o.nodeType == Node.ELEMENT_NODE && (x.node.isBlock(o) || 0 <= x.opts.htmlDoNotWrapTags.indexOf(o.tagName.toLowerCase()) && !x.node.hasClass(o, "fr-marker"))) i = null, r.appendChild(o.cloneNode(!0)); else if (o.nodeType != Node.ELEMENT_NODE && o.nodeType != Node.TEXT_NODE) i = null, r.appendChild(o.cloneNode(!0)); else if ("BR" == o.tagName) null == i ? (i = x.doc.createElement(n), s = !0, t && (i.setAttribute("class", "fr-temp-div"), i.setAttribute("data-empty", !0)), i.appendChild(o.cloneNode(!0)), r.appendChild(i)) : !1 === a && (i.appendChild(x.doc.createElement("br")), t && (i.setAttribute("class", "fr-temp-div"), i.setAttribute("data-empty", !0))), i = null; else {
                        var d = o.textContent;
        ...
        function l(e, t) {
            for (var n = e.length - 1; 0 <= n; n--) o(e[n], t);
        }
        ...
        function n(e) {
            ...
            for (var t = x.doc.createTreeWalker(e, NodeFilter.SHOW_TEXT, x.node.filter(function (e) {
                ...
                if (!s(n.parentNode, !0)) {
                    ...
                    if (r) {
                        var a = n.previousSibling, o = n.nextSibling;
        ...
        function u() {
            x.opts.htmlUntouched || (e(), t(), n(), x.spaces.normalize(null, !0), x.html.fillEmptyBlocks(), x.clean.lists(), x.clean.tables(), x.clean.toHTML5(), x.html.cleanBRs()), x.selection.restore(), i(), x.placeholder.refresh();
        }

        function i() {
            x.node.isEmpty(x.el) && (null != c() ? x.el.querySelector(p()) || x.el.querySelector(x.opts.htmlDoNotWrapTags.join(":not(.fr-marker),") + ":not(.fr-marker)") || (x.core.hasFocus() ? (x.$el.html("<" + c() + ">" + Ee.FE.MARKERS + "<br/></" + c() + ">"), x.selection.restore()) : x.$el.html("<" + c() + "><br/></" + c() + ">")) : x.el.querySelector("*:not(.fr-marker):not(br)") || (x.core.hasFocus() ? (x.$el.html(Ee.FE.MARKERS + "<br/>"), x.selection.restore()) : x.$el.html("<br/>")));
        }
        ...
        function g(e, t) {
            ...
            return x.node.rawAttributes(n.get(0));
        }
        ...
        function v(e, t) {
            x.opts.htmlExecuteScripts ? e.html(t) : e.get(0).innerHTML = t;
        }
        ...
        return {
            defaultTag: c, isPreformatted: s, emptyBlocks: a, emptyBlockTagsQuery: function () {
                return Ee.FE.BLOCK_TAGS.join(":empty, ") + ":empty";
            }, blockTagsQuery: p, fillEmptyBlocks: function (e) {
                for (var t = a(e), n = 0; n < t.length; n++) {
                    var r = t[n];
                    "false" === r.getAttribute("contenteditable") || r.querySelector(x.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)") || x.node.isVoid(r) || "TABLE" != r.tagName && "TBODY" != r.tagName && "TR" != r.tagName && "UL" != r.tagName && "OL" != r.tagName && r.appendChild(x.doc.createElement("br"));
                }
            ...
            }, cleanEmptyTags: e, cleanWhiteTags: E, cleanBlankSpaces: n, blocks: function () {
                return x.$el.get(0).querySelectorAll(p());
            }, getDoctype: N, set: function (e) {
                var t, n, r, i = x.clean.html((e || "").trim(), [], [], x.opts.fullPage);
                if (x.opts.fullPage) {
                    var a = h(i, "body") || (0 <= i.indexOf("<body") ? "" : i), o = g(i, "body"),
                        s = h(i, "head") || "<title></title>", l = g(i, "head"),
                ...
                if (!x.opts.useClasses && !t) {
                    ...
                    for (r = 0; r < x.doc.styleSheets.length; r++) {
                        var c, f = 0;
                        try {
                            c = x.doc.styleSheets[r].cssRules, x.doc.styleSheets[r].ownerNode && "STYLE" == x.doc.styleSheets[r].ownerNode.nodeType && (f = 1);
                        } catch (L) {
                        }
                    ...
                    for (r = 0; r < a.length; r++) if (a[r].getAttribute("class") && (a[r].setAttribute("fr-original-class", a[r].getAttribute("class")), a[r].removeAttribute("class")), 0 < (a[r].getAttribute("fr-original-style") || "").trim().length) {
                        var C = a[r].getAttribute("fr-original-style").split(";");
                        for (i = 0; i < C.length; i++) if (0 < C[i].indexOf(":")) {
                            var S = C[i].split(":"), R = S[0];
                            S.splice(0, 1), a[r].style[R.trim()] = S.join(":").trim();
                        }
                    }
                }
                if (x.node.isEmpty(x.el)) x.opts.fullPage && (n = N(x.iframe_document), n += "<html" + x.node.attributes(x.$html.get(0)) + ">" + x.$html.find("head").get(0).outerHTML + "<body></body></html>"); else if (void 0 === e && (e = !1), x.opts.fullPage) {
                ...
                if (!x.opts.useClasses && !t) for (r = 0; r < a.length; r++) a[r].getAttribute("fr-original-class") && (a[r].setAttribute("class", a[r].getAttribute("fr-original-class")), a[r].removeAttribute("fr-original-class")), null != a[r].getAttribute("fr-original-style") && void 0 !== a[r].getAttribute("fr-original-style") ? (0 !== a[r].getAttribute("fr-original-style").length ? a[r].setAttribute("style", a[r].getAttribute("fr-original-style")) : a[r].removeAttribute("style"), a[r].removeAttribute("fr-original-style")) : a[r].removeAttribute("style");
                ...
                return "string" == typeof _ && (n = _), n = n.replace(/<pre(?:[\w\W]*?)>(?:[\w\W]*?)<\/pre>/g, function (e) {
                ...
                var r, i, a;
                if (x.selection.isCollapsed() || x.selection.remove(), r = t ? e : x.clean.html(e), e.indexOf('class="fr-marker"') < 0 && (i = r, (a = x.doc.createElement("div")).innerHTML = i, x.selection.setAtEnd(a), r = a.innerHTML), x.node.isEmpty(x.el) && !x.opts.keepFormatOnDelete && f(r)) x.el.innerHTML = r; else {
            ...
            }, wrap: t, unwrap: function () {
                x.$el.find("div.fr-temp-div").each(function () {
                    this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && Ee(this).before("<br>"), Ee(this).attr("data-empty") || !this.nextSibling || x.node.isBlock(this.nextSibling) && !Ee(this.nextSibling).hasClass("fr-temp-div") ? Ee(this).replaceWith(Ee(this).html()) : Ee(this).replaceWith(Ee(this).html() + "<br>");
                }), x.$el.find(".fr-temp-div").removeClass("fr-temp-div").filter(function () {
                    return "" === Ee(this).attr("class");
                }).removeAttr("class");
            }, escapeEntities: function (e) {
                return e.replace(/</gi, "&lt;").replace(/>/gi, "&gt;").replace(/"/gi, "&quot;").replace(/'/gi, "&#39;");
            }, checkIfEmpty: i, extractNode: h, extractNodeAttrs: g, extractDoctype: m, cleanBRs: function () {
                for (var e = x.el.getElementsByTagName("br"), t = 0; t < e.length; t++) d(e[t]);
            }, _init: function () {
                if (x.$wp) {
                    var e = function () {
                        E(), x.placeholder && setTimeout(x.placeholder.refresh, 0);
                    };
    ...
    }, Ee.extend(Ee.FE.DEFAULTS, {language: null}), Ee.FE.LANGUAGE = {}, Ee.FE.MODULES.language = function (e) {
        var t;
        return {
            _init: function () {
    ...
    }, Ee.extend(Ee.FE.DEFAULTS, {placeholderText: "Type something"}), Ee.FE.MODULES.placeholder = function (c) {
        function e() {
            c.$placeholder || (c.$placeholder = Ee('<span class="fr-placeholder"></span>'), c.$wp.append(c.$placeholder));
            var e = c.opts.iframe ? c.$iframe.prev().outerHeight(!0) : c.$el.prev().outerHeight(!0), t = 0, n = 0,
                r = 0, i = 0, a = 0, o = 0, s = c.node.contents(c.el), l = Ee(c.selection.element()).css("text-align");
            ...
            c.$wp.addClass("show-placeholder"), c.$placeholder.css({
                ...
                paddingTop: Math.max(c.helpers.getPX(c.$el.css("padding-top")), i),
                paddingLeft: Math.max(c.helpers.getPX(c.$el.css("padding-left")), a),
                marginLeft: Math.max(c.helpers.getPX(c.$el.css("margin-left")), n),
                paddingRight: Math.max(c.helpers.getPX(c.$el.css("padding-right")), o),
        ...
        return {
            ...
            }, show: e, hide: t, refresh: n, isVisible: function () {
        ...
        return {
            _init: function () {
                ...
                for (var r in n.open(t, e, !0), a.opts.requestWithCredentials && (n.withCredentials = !0), a.opts.requestHeaders) a.opts.requestHeaders.hasOwnProperty(r) && n.setRequestHeader(r, a.opts.requestHeaders[r]);
                return n;
        ...
        return {
            _startEnter: function (e) {
                var t, n = m(e), r = n.nextSibling, i = n.previousSibling, a = g.html.defaultTag();
                if (g.node.isEmpty(n, !0) && r) {
                    ...
                    var d = "";
                    for (d = l.parentNode && "LI" == l.parentNode.tagName ? s + "<li>" + Ee.FE.MARKERS + "<br>" + o : a ? s + "<" + a + ">" + Ee.FE.MARKERS + "<br></" + a + ">" + o : s + Ee.FE.MARKERS + "<br>" + o, Ee(n).html('<span id="fr-break"></span>'); ["UL", "OL"].indexOf(l.tagName) < 0 || l.parentNode && "LI" === l.parentNode.tagName;) l = l.parentNode;
                ...
                if (r) {
                    ...
                    if (s == g.el) return !1;
                    if (s = s.nextSibling, g.node.isBlock(s)) Ee.FE.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (Ee(e).replaceWith(Ee.FE.MARKERS), (t = g.node.contents(n)).length && "BR" == t[t.length - 1].tagName && Ee(t[t.length - 1]).remove(), Ee(n).append(Ee(s).html()), Ee(s).remove()); else for ((t = g.node.contents(n)).length && "BR" == t[t.length - 1].tagName && Ee(t[t.length - 1]).remove(), Ee(e).replaceWith(Ee.FE.MARKERS); s && !g.node.isBlock(s) && "BR" != s.tagName;) Ee(n).append(Ee(s)), s = s.nextSibling;
                }
            }
        };
        ...
        function c(e) {
            ...
            if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType == Node.TEXT_NODE) {
                    var r = n.textContent, i = r.length;
                    ...
                    if (0 === n.textContent.length) if (a && u.opts.keepFormatOnDelete) Ee(n).after(Ee.FE.INVISIBLE_SPACE + Ee.FE.MARKERS); else if ((2 != n.parentNode.childNodes.length || n.parentNode != e.parentNode) && 1 != n.parentNode.childNodes.length || u.node.isBlock(n.parentNode) || u.node.isElement(n.parentNode) || !u.node.isDeletable(n.parentNode)) {
                    ...
                    } else Ee(n.parentNode).after(Ee.FE.MARKERS), Ee(n.parentNode).remove(); else Ee(n).after(Ee.FE.MARKERS);
            ...
            } else if (Ee.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n))) if (u.node.isDeletable(n)) Ee(e).replaceWith(Ee.FE.MARKERS), Ee(n).remove(); else if (u.node.isEmpty(n) && !u.node.isList(n)) Ee(n).remove(), Ee(e).replaceWith(Ee.FE.MARKERS); else {
        ...
        function l(e) {
            var t = 0 < Ee(e).parentsUntil(u.$el, "BLOCKQUOTE").length, n = u.node.deepestParent(e, [], !t);
            ...
            if (null !== n) {
                ...
                if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && a && Ee.FE.NO_DELETE_TAGS.indexOf(a.tagName) < 0) if (u.node.isDeletable(a)) Ee(a).remove(), Ee(e).replaceWith(Ee.FE.MARKERS); else if (u.node.isBlock(a) && u.node.isEditable(a)) if (u.node.isList(a)) if (u.node.isEmpty(n, !0)) Ee(n).remove(), Ee(a).find("li:first").prepend(Ee.FE.MARKERS); else {
                    ...
                    if ((i = u.node.contents(a)).length && "BR" == i[0].tagName && Ee(i[0]).remove(), "BLOCKQUOTE" != a.tagName && "BLOCKQUOTE" == n.tagName) for (i = u.node.contents(n); i.length && u.node.isBlock(i[i.length - 1]);) n = i[i.length - 1], i = u.node.contents(n); else if ("BLOCKQUOTE" == a.tagName && "BLOCKQUOTE" != n.tagName) for (i = u.node.contents(a); i.length && u.node.isBlock(i[0]);) a = i[0], i = u.node.contents(a);
        ...
        function n(e) {
            ...
            } else if (Ee.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n))) if (u.node.isDeletable(n)) Ee(e).replaceWith(Ee.FE.MARKERS), Ee(n).remove(); else if (u.node.isList(n)) e.previousSibling ? (Ee(n).find("li:first").prepend(e), u.cursorLists._backspace(e)) : (Ee(n).find("li:first").prepend(Ee.FE.MARKERS), Ee(e).remove()); else if ((t = u.node.contents(n)) && "BR" == t[0].tagName && Ee(t[0]).remove(), t && "BLOCKQUOTE" == n.tagName) {
                var r = t[0];
            ...
            enter: function (t) {
                ...
                0 < Ee(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !(t = !1)), Ee(n).parentsUntil(u.$el, "TD, TH").length && (r = !1), a(n) ? !s(n) || t || r ? p(n, t, r) : u.cursorLists._endEnter(n) : o(n) ? !s(n) || t || r ? function e(t, n, r) {
                    ...
                    if (null == a) (i = u.html.defaultTag()) && u.node.isElement(t.parentNode) ? Ee(t).replaceWith("<" + i + ">" + Ee.FE.MARKERS + "<br></" + i + ">") : Ee(t).replaceWith("<br>" + Ee.FE.MARKERS); else {
                        if (u.node.isBlock(a)) if ("PRE" == a.tagName && (n = !0), n) Ee(t).remove(), Ee(a).prepend("<br>" + Ee.FE.MARKERS); else {
                ...
                return a(t) ? e = c(t) : o(t) ? s(t) && h(t, Ee(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : function (e) {
                    ...
                    if (null !== n) {
                        ...
                        if (u.node.isBlock(n) && u.node.isEditable(n) && o && Ee.FE.NO_DELETE_TAGS.indexOf(o.tagName) < 0) if (u.node.isDeletable(o)) Ee(o).remove(), Ee(e).replaceWith(Ee.FE.MARKERS); else if (u.node.isEditable(o)) if (u.node.isBlock(o)) if (u.node.isEmpty(o) && !u.node.isList(o)) Ee(o).remove(), Ee(e).after(u.opts.keepFormatOnDelete ? Ee.FE.INVISIBLE_SPACE : ""); else {
                            if (u.node.isList(o) && (o = Ee(o).find("li:last").get(0)), (a = u.node.contents(o)).length && "BR" == a[a.length - 1].tagName && Ee(a[a.length - 1]).remove(), "BLOCKQUOTE" == o.tagName && "BLOCKQUOTE" != n.tagName) for (a = u.node.contents(o); a.length && u.node.isBlock(a[a.length - 1]);) o = a[a.length - 1], a = u.node.contents(o); else if ("BLOCKQUOTE" != o.tagName && "BLOCKQUOTE" == n.tagName) for (a = u.node.contents(n); a.length && u.node.isBlock(a[0]);) n = a[0], a = u.node.contents(n);
                ...
                if (!e) return !1;
                if (u.el.normalize(), a(e)) if (s(e)) if (0 === Ee(e).parents("li:first").find("ul, ol").length) u.cursorLists._del(e); else {
        ...
        function e() {
            if (l.browser.mozilla && l.selection.isCollapsed() && !c) {
                var e = l.selection.ranges(0), t = e.startContainer, n = e.startOffset;
        ...
        function o(e) {
            ...
            c = !1;
            var r, i, a, o = g(n) && !u(e) && !e.altKey, s = n == Ee.FE.KEYCODE.BACKSPACE || n == Ee.FE.KEYCODE.DELETE;
            ...
            n == Ee.FE.KEYCODE.ENTER ? e.shiftKey ? ((a = e).preventDefault(), a.stopPropagation(), l.opts.multiLine && (l.selection.isCollapsed() || l.selection.remove(), l.cursor.enter(!0))) : (i = e, l.opts.multiLine ? (l.helpers.isIOS() || (i.preventDefault(), i.stopPropagation()), l.selection.isCollapsed() || l.selection.remove(), l.cursor.enter()) : (i.preventDefault(), i.stopPropagation())) : n === Ee.FE.KEYCODE.BACKSPACE && (e.metaKey || e.ctrlKey) ? setTimeout(function () {
            ...
            }, 0) : n != Ee.FE.KEYCODE.BACKSPACE || u(e) || e.altKey ? n != Ee.FE.KEYCODE.DELETE || u(e) || e.altKey || e.shiftKey ? n == Ee.FE.KEYCODE.SPACE ? function (e) {
                var t = l.selection.element();
                ...
                } else e.preventDefault(), e.stopPropagation(); else e.preventDefault(), e.stopPropagation(), l.selection.remove(), l.html.fillEmptyBlocks();
        ...
        function b(e) {
            var t = l.el.childNodes, n = l.html.defaultTag();
        ...
        return {
            _init: function () {
                l.events.on("keydown", m), l.events.on("input", e), l.events.on("mousedown", a), l.events.on("keyup input", v), l.events.on("keypress", i), l.events.on("keydown", o), l.events.on("keyup", p), l.events.on("destroy", T), l.events.on("html.inserted", p), l.events.on("cut", t), l.events.on("click", b);
            }, ctrlKey: u, isCharacter: g, isArrow: h, forceUndo: function () {
                n && (clearTimeout(n), l.undo.saveStep(), r = null);
            }, isIME: function () {
                return c;
            }, isBrowserAction: function (e) {
                var t = e.which;
                return u(e) || t == Ee.FE.KEYCODE.F5;
            }, positionCaret: s
        };
        ...
        return {
            _init: function () {
            ...
            }, registerToolbar: r, focusToolbarElement: s, focusToolbar: p, focusContent: u, focusPopup: function (r) {
            ...
            }, focusEditor: v, focusPopupButton: E, focusModalButton: function (e) {
                ...
                var n = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey, r = e.which, i = !1;
            ...
            }, saveSelection: t, restoreSelection: function () {
        ...
        function n(e, t) {
            ...
            if (void 0 === t && (t = {}), t.style && delete t.style, g.selection.isCollapsed()) {
                ...
                do {
                    for (r = g.$el.find(f(e, t) + " > " + f(e, t)), n = 0; n < r.length; n++) r[n].outerHTML = r[n].innerHTML;
                } while (r.length);
                g.el.normalize();
        ...
        function v(e, t, n, r) {
            if (!r) {
                var i = !1;
                if (!0 === e.data("type")) for (; g.node.isFirstSibling(e.get(0)) && !e.parent().is(g.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().before(e), i = !0; else if (!1 === e.data("type")) for (; g.node.isLastSibling(e.get(0)) && !e.parent().is(g.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().after(e), i = !0;
                if (i) return !0;
            }
        ...
        function r(t, n) {
            ...
            !function e(t, n, r, i) {
                for (var a = g.node.contents(t.get(0)), o = 0; o < a.length; o++) {
                    var s = a[o];
                    if (g.node.hasClass(s, "fr-marker")) n = (n + 1) % 2; else if (n) if (0 < Ee(s).find(".fr-marker").length) n = e(Ee(s), n, r, i); else {
        ...
        function t(e, t) {
            ...
            if (g.selection.isCollapsed()) {
                ...
                if (g.selection.save(), null == t || "color" == e && 0 < g.$el.find(".fr-marker").parents("u, a").length) {
                    ...
                    for (n = 0; n < c.length; n++) if (!0 === (r = Ee(c[n])).data("type")) for (; g.node.isFirstSibling(r.get(0)) && !r.parent().is(g.$el) && !g.node.isElement(r.parent().get(0)) && !g.node.isBlock(r.parent().get(0));) r.parent().before(r); else for (; g.node.isLastSibling(r.get(0)) && !r.parent().is(g.$el) && !g.node.isElement(r.parent().get(0)) && !g.node.isBlock(r.parent().get(0));) r.parent().after(r);
                }
                var f = g.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling, p = {"class": "fr-unprocessed"};
        ...
        function E(e, t, n) {
            var r, i, a, o = e.parentsUntil(g.$el, "span[style]"), s = [];
        ...
        function i(e, t) {
            ...
            var n = g.selection.ranges(0), r = n.startContainer;
        ...
        return {
            is: i, toggle: function (e, t) {
                i(e, t) ? r(e, t) : n(e, t);
            }, apply: n, remove: r, applyStyle: t, removeStyle: function (e) {
                t(e, null);
            }
        };
        ...
        function t(e, t) {
            if (!1 !== o.events.trigger("commands.before", Ee.merge([e], t || []))) {
                var n = Ee.FE.COMMANDS[e] && Ee.FE.COMMANDS[e].callback || a[e], r = !0, i = !1;
        ...
        function n(e) {
            ...
            for (var t = o.selection.blocks(), n = 0; n < t.length; n++) if ("LI" != t[n].tagName && "LI" != t[n].parentNode.tagName) {
                var r = Ee(t[n]),
        ...
        var g, m, v = h(function (e) {
            ...
            for (var t = "", n = h("charCodeAt"), r = h("fromCharCode"), i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".indexOf(e[0]), a = 1; a < e.length - 2; a++) {
                for (var o = d(++i), s = e[n](a), l = ""; /[0-9-]/.test(e[a + 1]);) l += e[++a];
        ...
        function C(e) {
            for (var t = [v("9qqG-7amjlwq=="), v("KA3B3C2A6D1D5H5H1A3=="), v("3B9B3B5F3C4G3E3=="), v("QzbzvxyB2yA-9m=="), v("ji1kacwmgG5bc=="), v("nmA-13aogi1A3c1jd==")], n = 0; n < t.length; n++) if (String.prototype.endsWith || (String.prototype.endsWith = function (e, t) {
    ...
    }), Ee.FE.MODULES.paste = function (b) {
        var o, s, i, T;
        ...
        function e(e) {
            ...
            n(t, Ee("<div>").html(t).text()), "cut" == e.type && (b.undo.saveStep(), setTimeout(function () {
        ...
        function r(e) {
            if (e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData) {
                ...
                if (o = "", /text\/rtf/.test(t) && (s = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? o = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && b.browser.safari ? o = s : /text\/plain/.test(t) && !this.browser.mozilla && (o = b.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== o) {
                    b.keys.forceUndo(), T = b.snapshot.get(), b.selection.save(), b.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-helper");
                    var i = b.markers.insertAtPoint(e);
                    if (b.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"), b.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"), b.selection.restore(), b.selection.remove(), b.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"), !1 !== i) {
                        var a = b.el.querySelector(".fr-marker");
                        return Ee(a).replaceWith(Ee.FE.MARKERS), b.selection.restore(), l(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1;
                    }
                } else o = null;
            }
        }
        ...
        function d(e, t, n) {
            ...
            if (!t && ((l = function (e) {
                ...
                b.opts.htmlAllowedStyleProps = b.opts.pasteAllowedStyleProps, b.opts.htmlAllowComments = !1, e = (e = (e = e.replace(/<span class="Apple-tab-span">\s*<\/span>/g, A(b.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function (e, t) {
                    return A(t.length * (b.opts.tabSpaces || 4));
                })).replace(/\t/g, A(b.opts.tabSpaces || 4)), e = b.clean.html(e, b.opts.pasteDeniedTags, b.opts.pasteDeniedAttrs), b.opts.htmlAllowedStyleProps = d, b.opts.htmlAllowComments = !0, e = (e = (e = C(e)).replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, "");
            }
            !t || b.wordPaste && n || (0 === (e = e.replace(/^\n*/g, "").replace(/^ /g, "")).indexOf("<colgroup>") && (e = "<table>" + e + "</table>"), e = C(e = function (e) {
                ...
                for (t = 0; t < o.length; t++) {
                    var s = o[t], l = s.previousElementSibling;
                    if (l && "LI" == l.tagName) {
                ...
                var t, n = null, r = b.doc.createElement("div");
                r.innerHTML = e;
                ...
                var a = function (e) {
                    for (var t = b.node.contents(e), n = 0; n < t.length; n++) t[n].nodeType != Node.TEXT_NODE && t[n].nodeType != Node.ELEMENT_NODE ? t[n].parentNode.removeChild(t[n]) : a(t[n]);
                };
            ...
            if ("string" == typeof c && (e = c), "" !== e) {
                ...
                if (b.opts.enter == Ee.FE.ENTER_BR) for (r = (i = f.querySelectorAll("p, div")).length - 1; 0 <= r; r--) 0 === (a = i[r]).attributes.length && (a.outerHTML = a.innerHTML + (a.nextSibling && !b.node.isEmpty(a) ? "<br>" : "")); else if (b.opts.enter == Ee.FE.ENTER_DIV) for (r = (i = f.getElementsByTagName("p")).length - 1; 0 <= r; r--) 0 === (a = i[r]).attributes.length && (a.outerHTML = "<div>" + a.innerHTML + "</div>"); else b.opts.enter == Ee.FE.ENTER_P && 1 == f.childNodes.length && "P" == f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
        ...
        function C(e) {
            ...
            for (var r = c(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length;) {
                var i = r[r.length - 1];
                if (b.html.defaultTag() && "div" != b.html.defaultTag()) i.querySelector(b.html.blockTagsQuery()) ? i.outerHTML = i.innerHTML : i.outerHTML = "<" + b.html.defaultTag() + ">" + i.innerHTML + "</" + b.html.defaultTag() + ">"; else {
                    var a = i.querySelectorAll("*");
                    !a.length || "BR" !== a[a.length - 1].tagName && 0 === i.innerText.length ? i.outerHTML = i.innerHTML + "<br>" : i.outerHTML = i.innerHTML;
                }
            ...
            for (r = c(Array.prototype.slice.call(n.querySelectorAll("div:not([style])"))); r.length;) {
                for (t = 0; t < r.length; t++) {
                    var o = r[t], s = o.innerHTML.replace(/\u0009/gi, "").trim();
                    o.outerHTML = s;
                }
        ...
        return {
            _init: function () {
                b.el.addEventListener("copy", e), b.el.addEventListener("cut", e), b.el.addEventListener("paste", t, {capture: !0}), b.events.on("drop", r), b.browser.msie && b.browser.version < 11 && (b.events.on("mouseup", function (e) {
                    2 == e.button && (setTimeout(function () {
                        a = !1;
                    }, 50), a = !0);
                }, !0), b.events.on("beforepaste", t)), b.events.on("destroy", f);
            }, cleanEmptyTagsAndDivs: C, getRtfClipboard: function () {
                return s;
            }, saveCopiedText: n, clean: d
        };
    }, Ee.extend(Ee.FE.DEFAULTS, {
        shortcutsEnabled: [],
        shortcutsHint: !0
        ...
        function e(e) {
            ...
            if (n && Ee.FE.SHORTCUTS_MAP[r]) {
                ...
                if (i && 0 <= s.opts.shortcutsEnabled.indexOf(i)) {
                    var a, o = Ee.FE.SHORTCUTS_MAP[r].val;
        ...
        return {
            _init: function () {
                ...
                if (!r) for (var t in r = {}, Ee.FE.SHORTCUTS_MAP) Ee.FE.SHORTCUTS_MAP.hasOwnProperty(t) && 0 <= s.opts.shortcutsEnabled.indexOf(Ee.FE.SHORTCUTS_MAP[t].cmd) && (r[Ee.FE.SHORTCUTS_MAP[t].cmd + "." + (Ee.FE.SHORTCUTS_MAP[t].val || "")] = {
        ...
        function r(e, t) {
            try {
                var n = d(t.scLoc), r = t.scOffset, i = d(t.ecLoc), a = t.ecOffset, o = l.doc.createRange();
        ...
        return {
            ...
            }, dropRedo: r, reset: i, saveStep: function (e) {
        ...
        Ee.FE.ICONS[e] = t;
    }, Ee.extend(Ee.FE.DEFAULTS, {iconsTemplate: "font_awesome"}), Ee.FE.MODULES.icon = function (i) {
        return {
            create: function (n) {
                var e = null, r = Ee.FE.ICONS[n];
                if (void 0 !== r) {
                    var t = r.template || Ee.FE.ICON_DEFAULT_TEMPLATE || i.opts.iconsTemplate;
                    r.FA5NAME || (r.FA5NAME = r.NAME), t && (t = Ee.FE.ICON_TEMPLATES[t]) && (e = t.replace(/\[([a-zA-Z0-9]*)\]/g, function (e, t) {
                        return "NAME" == t ? r[t] || n : r[t];
                    }));
                }
                return e || n;
            }, getTemplate: function (e) {
                var t = Ee.FE.ICONS[e], n = i.opts.iconsTemplate;
        ...
        return {
            hide: r, to: a, bind: function (e, t, n) {
        ...
        function d(e, t) {
            var n, r = Ee();
            if (!e) return r;
            for (n in r = (r = r.add(l(o, e, t))).add(l(s, e, t)), u.shared.popups) if (u.shared.popups.hasOwnProperty(n)) {
        ...
        function t(e) {
            ...
            u.node.hasClass(e.get(0), "fr-dropdown") ? function (e) {
                var t = e.next(), n = u.node.hasClass(e.get(0), "fr-active"), r = d(".fr-dropdown.fr-active").not(e),
        ...
        function h(e, t, n) {
            ...
            var o = t.popup ? ' data-popup="true"' : "", s = t.modal ? ' data-modal="true"' : "",
                l = u.shortcuts.get(e + ".");
            l = l ? " (" + l + ")" : "";
            var d = e + "-" + u.id, c = "dropdown-menu-" + d,
            ...
            if ("dropdown" == t.type) {
                ...
                p += function (e, t) {
                    ...
                    if (t.html) "function" == typeof t.html ? n += t.html.call(u) : n += t.html; else {
                        var r = t.options;
                        for (var i in "function" == typeof r && (r = r()), n += '<ul class="fr-dropdown-list" role="presentation">', r) if (r.hasOwnProperty(i)) {
        ...
        return {
            _init: function () {
                ...
                var t, n = e.parents(".fr-popup, .fr-toolbar").data("instance") || u, r = e.data("cmd");
            ...
            }, bulkRefresh: n, exec: r, click: t, hideActiveDropdowns: c, getButtons: d
        };
        ...
        function c(e, t) {
            if (d[e]) {
                var n = d[e].$modal, r = n.data("instance") || l;
        ...
        return {
            _init: function () {
                ...
                if (l.shared.$overlay || (l.shared.$overlay = Ee('<div class="fr-overlay">').appendTo("body:first")), s = l.shared.$overlay, l.opts.theme && s.addClass(l.opts.theme + "-theme"), !d[n]) {
                    ...
                    d[n] = {
                        ...
                        var t = e.which;
                        return t == Ee.FE.KEYCODE.ESC ? (c(n), l.accessibility.focusModalButton(r), !1) : !(!Ee(e.currentTarget).is("input[type=text], textarea") && t != Ee.FE.KEYCODE.ARROW_UP && t != Ee.FE.KEYCODE.ARROW_DOWN && !l.keys.isBrowserAction(e) && (e.preventDefault(), e.stopPropagation(), 1));
                    }, !0), c(n, !0);
                }
                var i, a, o;
                return d[n];
            ...
            }, hide: c, resize: function (e) {
                if (d[e]) {
                    var t = d[e], n = t.$modal, r = t.$body, i = Ee(l.o_win).height(), a = n.find(".fr-modal-wrapper"),
                        o = i - a.outerHeight(!0) + (a.height() - (r.outerHeight(!0) - r.height())), s = "auto";
                    o < r.get(0).scrollHeight && (s = o), r.height(s);
                }
            }, isVisible: n, areVisible: function (e) {
                for (var t in d) if (d.hasOwnProperty(t) && n(t) && (void 0 === e || d[t].$modal.data("instance") == e)) return d[t].$modal;
                return !1;
            }
        };
    }, Ee.FE.POPUP_TEMPLATES = {"text.edit": "[_EDIT_]"}, Ee.FE.RegisterTemplate = function (e, t) {
        ...
        function v(r) {
            ...
            return {
                _windowResize: function () {
                    ...
                    var t = i.data("instance") || c, n = Ee(e.currentTarget);
                    ...
                    if (!c.core.sameInstance(i)) return !0;
                    var t = i.data("instance") || c, n = e.which;
                    ...
                    if (c.$wp && u(r) && i.parent().get(0) == c.$sc.get(0)) {
                        var e = i.offset().top - c.$wp.offset().top, t = c.$wp.outerHeight();
        ...
        return c.shared.exit_flag = !1, {
            ...
            }, hide: n, onHide: function (e, t) {
                c.events.on("popups.hide." + e, t);
            }, hideAll: g, setContainer: p, refresh: function (e) {
        ...
        function i() {
            ...
            if (0 === e.top && 0 === e.left && 0 === e.width || 0 === e.height) {
                ...
                var r = n.offset(), i = n.outerHeight();
        ...
        function a(e, t, n, r) {
            ...
            var a, o,
                s = (a = e, o = n.outerWidth(!0), a + o > v.$sc.get(0).clientWidth - 10 && (a = v.$sc.get(0).clientWidth - o - 10), a < 0 && (a = 10), a);
            if (e) {
                n.css("left", s);
            ...
            t && n.css("top", function (e, t, n) {
                ...
                if (!v.helpers.isMobile() && v.$tb && e.parent().get(0) != v.$tb.get(0)) {
                    var i = e.parent().offset().top, a = t - r - (n || 0);
        ...
        function n(e) {
            var n = Ee(e), t = n.is(".fr-sticky-on"), r = n.data("sticky-top"), i = n.data("sticky-scheduled");
            if (void 0 === r) {
                n.data("sticky-top", 0);
        ...
        function t(e) {
            if (e.offsetWidth) {
                var t, n, r = Ee(e), i = r.outerHeight(), a = r.data("sticky-position"),
                ...
                var d = "body" == v.opts.scrollableContainer ? v.helpers.scrollTop() : s, c = r.is(".fr-sticky-on");
                r.data("sticky-parent") || r.data("sticky-parent", r.parent());
                var f = r.data("sticky-parent"), p = f.offset().top, u = f.outerHeight();
        ...
        function r() {
            ...
            return e.cssText = "position:" + ["-webkit-", "-moz-", "-ms-", "-o-", ""].join("sticky; position:") + " sticky;", -1 !== e.position.indexOf("sticky") && !v.helpers.isIOS() && !v.helpers.isAndroid() && !v.browser.chrome;
        }
        ...
        return {
            _init: function () {
                !function () {
                    if (!r()) if (v._stickyElements = [], v.helpers.isIOS()) {
                        var t = function () {
                        ...
                        t(), v.events.$on(Ee(v.o_win), "scroll", function () {
                            if (v.core.hasFocus()) for (var e = 0; e < v._stickyElements.length; e++) {
                                var t = Ee(v._stickyElements[e]), n = t.parent(), r = v.helpers.scrollTop();
                ...
                var t = i();
                e.css({top: 0, left: 0});
                var n = t.top + t.height, r = t.left + t.width / 2 - e.get(0).offsetWidth / 2 + v.helpers.scrollLeft();
                v.opts.iframe || (n += v.helpers.scrollTop()), a(r, n, e, t.height);
            }, addSticky: function (e) {
                e.addClass("fr-sticky"), v.helpers.isIOS() && e.addClass("fr-sticky-ios"), r() || (e.removeClass("fr-sticky"), v._stickyElements.push(e.get(0)));
            }, refresh: e, at: a, getBoundingRect: i
        };
        ...
        function e() {
            ...
            for (var t = 0; t < e.length; t++) if ("|" == e[t] || "-" == e[t]) i.$tb.append(i.button.buildList([e[t]])); else {
                var n = i.$tb.find('> .fr-command[data-cmd="' + e[t] + '"]'), r = null;
        ...
        return {
            ...
            }, hide: n, show: function () {
                if (!1 === i.events.trigger("toolbar.show")) return !1;
                i.$tb.show();
            }, showInline: t, disable: function () {
                !u && i.$tb && (i.$tb.find("> .fr-command").addClass("fr-disabled fr-no-refresh").attr("aria-disabled", !0), u = !0);
            }, enable: function () {
                u && i.$tb && (i.$tb.find("> .fr-command").removeClass("fr-disabled fr-no-refresh").attr("aria-disabled", !1), u = !1), i.button.bulkRefresh();
            }
        };
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Ee.FE.COMMANDS.align.options;
        ...
        function x(r, e) {
            ...
            function v() {
                for (var e = ""; f.test(g());) h(), e += c;
                return e;
            }

            function E() {
                var e = "";
                for (c && f.test(c) && (e = c); f.test(h());) e += c;
                return e;
            }
            ...
            var C = r.match(/^[\t ]*/)[0], S = new Array(i + 1).join(a), R = 0, y = 0;
            for (var _, L, x = {
                "{": function (e) {
                    x.singleSpace(), N.push(e), x.newLine();
                }, "}": function (e) {
                    x.newLine(), N.push(e), x.newLine();
                }, _lastCharWhitespace: function () {
                    return f.test(N[N.length - 1]);
                }, newLine: function (e) {
                    N.length && (e || "\n" === N[N.length - 1] || x.trim(), N.push("\n"), C && N.push(C));
                }, singleSpace: function () {
                    N.length && !x._lastCharWhitespace() && N.push(" ");
                }, preserveSingleSpace: function () {
                    M && x.singleSpace();
                }, trim: function () {
                    for (; x._lastCharWhitespace();) N.pop();
                }
            }, N = [], O = !1, w = !1, I = !1, D = "", k = ""; ;) {
                var F = E(), M = "" !== F, $ = -1 !== F.indexOf("\n");
                if (k = D, !(D = c)) break;
                if ("/" === c && "*" === g()) {
                    var B = 0 === R;
                    ($ || B) && x.newLine(), N.push(b()), x.newLine(), B && x.newLine(!0);
                } else if ("/" === c && "/" === g()) $ || "{" === k || x.trim(), x.singleSpace(), N.push(b()), x.newLine(); else if ("@" === c) {
        ...
        function N(e, t) {
            return new function (r, e) {
                var o, i, a, s, l, d, c, f, p, t, n, u, h, g = [], m = "";
                ...
                u = {
                    TK_START_EXPR: function () {
                        ...
                        "expand" === h.brace_style ? e || A() : e || (_(f.mode) && h.keep_array_indentation ? (h.keep_array_indentation = !1, A(), h.keep_array_indentation = !0) : A()), x(), S();
                    }, TK_WORD: D, TK_RESERVED: D, TK_SEMICOLON: function () {
                        for (O() && (o.space_before_token = !1); f.mode === k.Statement && !f.if_block && !f.do_block;) x();
                        S();
                    }, TK_STRING: function () {
                        O() ? o.space_before_token = !0 : "TK_RESERVED" === l || "TK_WORD" === l ? o.space_before_token = !0 : "TK_COMMA" === l || "TK_START_EXPR" === l || "TK_EQUALS" === l || "TK_OPERATOR" === l ? N() || T() : A(), S();
                    }, TK_EQUALS: function () {
                        O(), f.declaration_statement && (f.declaration_assignment = !0), o.space_before_token = !0, S(), o.space_before_token = !0;
                        ...
                        }(s.text), n = !1, r = !1, i = s.whitespace_before, a = i.length;
                        for (A(!1, !0), 1 < t.length && (function (e, t) {
                            for (var n = 0; n < e.length; n++) {
                                var r = V(e[n]);
                                if (r.charAt(0) !== t) return !1;
                            }
                            return !0;
                        }(t.slice(1), "*") ? n = !0 : function (e, t) {
                        ...
                        s.wanted_newline ? A(!1, !0) : o.trim(!0), o.space_before_token = !0, S(), A(!1, !0);
                    }, TK_DOT: function () {
                        O(), "TK_RESERVED" === l && w(f.last_text) ? o.space_before_token = !0 : T(")" === f.last_text && h.break_chained_methods), S();
                    }, TK_UNKNOWN: function () {
                ...
                var E = 0;
                if (r && r.length) {
                    for (; " " === r.charAt(E) || "\t" === r.charAt(E);) m += r.charAt(E), E += 1;
                    r = r.substring(E);
                }

                function b(e) {
                    var t = e.newlines, n = h.keep_array_indentation && _(f.mode);
                    if (n) for (r = 0; r < t; r += 1) A(0 < r); else if (h.max_preserve_newlines && t > h.max_preserve_newlines && (t = h.max_preserve_newlines), h.preserve_newlines && 1 < e.newlines) {
                        A();
                ...
                function A(e, t) {
                    if (!t && ";" !== f.last_text && "," !== f.last_text && "=" !== f.last_text && "TK_OPERATOR" !== l) for (; f.mode === k.Statement && !f.if_block && !f.do_block;) x();
                ...
                function O() {
                    return !!("TK_RESERVED" === l && G(f.last_text, ["var", "let", "const"]) && "TK_WORD" === s.type || "TK_RESERVED" === l && "do" === f.last_text || "TK_RESERVED" === l && "return" === f.last_text && !s.wanted_newline || "TK_RESERVED" === l && "else" === f.last_text && ("TK_RESERVED" !== s.type || "if" !== s.text) || "TK_END_EXPR" === l && (p.mode === k.ForInitializer || p.mode === k.Conditional) || "TK_WORD" === l && f.mode === k.BlockStatement && !f.in_case && "--" !== s.text && "++" !== s.text && "function" !== d && "TK_WORD" !== s.type && "TK_RESERVED" !== s.type || f.mode === k.ObjectLiteral && (":" === f.last_text && 0 === f.ternary_depth || "TK_RESERVED" === l && G(f.last_text, ["get", "set"]))) && (y(k.Statement), R(), "TK_RESERVED" === l && G(f.last_text, ["var", "let", "const"]) && "TK_WORD" === s.type && (f.declaration_statement = !0), N() || T("TK_RESERVED" === s.type && G(s.text, ["do", "for", "if", "while"])), !0);
                }
                ...
                function D() {
                    if ("TK_RESERVED" === s.type && f.mode !== k.ObjectLiteral && G(s.text, ["set", "get"]) && (s.type = "TK_WORD"), "TK_RESERVED" === s.type && f.mode === k.ObjectLiteral) {
                        var e = I(1);
                        ":" == e.text && (s.type = "TK_WORD");
                    }
                ...
                l = "TK_START_BLOCK", d = "", (o = new function (t, n) {
                    ...
                    this.baseIndentString = n, this.indent_string = t, this.previous_line = null, this.current_line = null, this.space_before_token = !1, this.add_outputline = function () {
                        ...
                        if (!e.multiline_frame && e.mode !== k.ForInitializer && e.mode !== k.Conditional) for (var t = e.start_line_index, n = r.length; t < n;) r[t].remove_indent(), t++;
                    ...
                    for (a = new function (y, _, e) {
                        ...
                        function o() {
                            ...
                            if ("/" === r) {
                                ...
                                if ("/" === y.charAt(M)) {
                                    M += 1, K.lastIndex = M;
                                    var l = K.exec(y);
                                    return s = "//" + l[0], M += l[0].length, [s, "TK_COMMENT"];
                                }
                            }
                            if ("`" === r || "'" === r || '"' === r || ("/" === r || _.e4x && "<" === r && y.slice(M - 1).match(/^<([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/)) && ("TK_RESERVED" === t.type && G(t.text, ["return", "case", "throw", "else", "do", "typeof", "yield"]) || "TK_END_EXPR" === t.type && ")" === t.text && t.parent && "TK_RESERVED" === t.parent.type && G(t.parent.text, ["if", "while", "for"]) || G(t.type, ["TK_COMMENT", "TK_START_EXPR", "TK_START_BLOCK", "TK_END_BLOCK", "TK_OPERATOR", "TK_EQUALS", "TK_EOF", "TK_SEMICOLON", "TK_COMMA"]))) {
                                var c = r, f = !1, p = !1;
                                if (e = r, "/" === c) for (var u = !1; M < $ && (f || u || y.charAt(M) !== c) && !Y.newline.test(y.charAt(M));) e += y.charAt(M), f ? f = !1 : (f = "\\" === y.charAt(M), "[" === y.charAt(M) ? u = !0 : "]" === y.charAt(M) && (u = !1)), M += 1; else if (_.e4x && "<" === c) {
                                    var h = /<(\/?)([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/g,
                                        g = y.slice(M - 1), m = h.exec(g);
                                    if (m && 0 === m.index) {
                                        for (var v = m[2], E = 0; m;) {
                                            var b = !!m[1], T = m[2],
                                ...
                                } else for (; M < $ && (f || y.charAt(M) !== c && ("`" === c || !Y.newline.test(y.charAt(M))));) (f || "`" === c) && Y.newline.test(y.charAt(M)) ? ("\r" === y.charAt(M) && "\n" === y.charAt(M + 1) && (M += 1), e += "\n") : e += y.charAt(M), f ? ("x" !== y.charAt(M) && "u" !== y.charAt(M) || (p = !0), f = !1) : f = "\\" === y.charAt(M), M += 1;
                                if (p && _.unescape_strings && (e = function (e) {
                                    var t, n = !1, r = "", i = 0, a = "", o = 0;
                                    for (; n || i < e.length;) if (t = e.charAt(i), i++, n) {
                                    ...
                                    return r;
                                }(e)), M < $ && y.charAt(M) === c && (e += c, M += 1, "/" === c)) for (; M < $ && Y.isIdentifierStart(y.charCodeAt(M));) e += y.charAt(M), M += 1;
                                return [e, "TK_STRING"];
                            }
                            if ("#" === r) {
                                if (0 === F.length && "!" === y.charAt(M)) {
                                    for (e = r; M < $ && "\n" !== r;) r = y.charAt(M), e += r, M += 1;
                                    return [V(e) + "\n", "TK_UNKNOWN"];
                                }
                                var S = "#";
                                if (M < $ && x.test(y.charAt(M))) {
                                    for (; r = y.charAt(M), S += r, (M += 1) < $ && "#" !== r && "=" !== r;) ;
                        ...
                        this.tokenize = function () {
                            ...
                            for (var r = null, i = [], a = []; !t || "TK_EOF" !== t.type;) {
                                for (n = o(), e = new X(n[1], n[0], I, D); "TK_COMMENT" === e.type || "TK_BLOCK_COMMENT" === e.type || "TK_UNKNOWN" === e.type;) "TK_BLOCK_COMMENT" === e.type && (e.directives = n[2]), a.push(e), n = o(), e = new X(n[1], n[0], I, D);
            ...
            run: function (e, t) {
                ...
                for ((t = t || {}).wrap_line_length !== undefined && 0 !== parseInt(t.wrap_line_length, 10) || t.max_char === undefined || 0 === parseInt(t.max_char, 10) || (t.wrap_line_length = t.max_char), r = t.indent_inner_html !== undefined && t.indent_inner_html, i = t.indent_size === undefined ? 4 : parseInt(t.indent_size, 10), m = t.indent_char === undefined ? " " : t.indent_char, s = t.brace_style === undefined ? "collapse" : t.brace_style, a = 0 === parseInt(t.wrap_line_length, 10) ? 32786 : parseInt(t.wrap_line_length || 250, 10), v = t.unformatted || ["a", "span", "img", "bdo", "em", "strong", "dfn", "code", "samp", "kbd", "var", "cite", "abbr", "acronym", "q", "sub", "sup", "tt", "i", "b", "big", "small", "u", "s", "strike", "font", "ins", "del", "address", "pre"], l = t.preserve_newlines === undefined || t.preserve_newlines, d = l ? isNaN(parseInt(t.max_preserve_newlines, 10)) ? 32786 : parseInt(t.max_preserve_newlines, 10) : 0, E = t.indent_handlebars !== undefined && t.indent_handlebars, b = t.wrap_attributes === undefined ? "auto" : t.wrap_attributes, T = t.wrap_attributes_indent_size === undefined ? i : parseInt(t.wrap_attributes_indent_size, 10) || i, c = t.end_with_newline !== undefined && t.end_with_newline, f = Array.isArray(t.extra_liners) ? t.extra_liners.concat() : "string" == typeof t.extra_liners ? t.extra_liners.split(",") : "head,body,/html".split(","), t.indent_with_tabs && (m = "\t", i = 1), (n = new function () {
                    return this.pos = 0, this.token = "", this.current_mode = "CONTENT", this.tags = {
                        ...
                        var t, n, r = "", i = [], a = "", o = !1, s = !0, l = this.pos, d = this.line_char_count;
                        e = e !== undefined && e;
                        do {
                            ...
                            if (r = this.input.charAt(this.pos), this.pos++, this.Utils.in_array(r, this.Utils.whitespace)) o = !0; else {
                                if ("'" != r && '"' != r || (r += this.get_unformatted(r), o = !0), "=" == r && (o = !1), i.length && "=" != i[i.length - 1] && ">" != r && o) {
                                    if (this.space_or_wrap(i), o = !1, !s && "force" == b && "/" != r) {
                                        ...
                                        for (var c = 0; c < T; c++) i.push(m);
                                    }
                                    for (var f = 0; f < i.length; f++) if (" " == i[f]) {
                                        s = !1;
                                        break;
                                    }
                                }
                    ...
                    switch (n.token_type) {
                        ...
                        case"TK_TAG_END":
                            if ("TK_CONTENT" == n.last_token && "" === n.last_text) {
                                var u = n.token_text.match(/\w+/)[0], h = null;
        ...
        function i(e) {
            ...
            if (l.core.hasFocus() && (i = !0, l.events.disableBlur(), l.$el.blur()), t = (t = t.replace(/<span class="fr-tmp fr-sm">F<\/span>/, "FROALA-SM")).replace(/<span class="fr-tmp fr-em">F<\/span>/, "FROALA-EM"), l.codeBeautifier && (t = l.codeBeautifier.run(t, l.opts.codeBeautifierOptions)), c) {
                ...
                n = t.substring(0, n).length - t.substring(0, t.substring(0, n).lastIndexOf("\n") + 1).length, r = t.substring(0, r).length - t.substring(0, t.substring(0, r).lastIndexOf("\n") + 1).length, c.setSize(null, l.opts.height ? l.opts.height : "auto"), l.opts.heightMin && l.$box.find(".CodeMirror-scroll").css("min-height", l.opts.heightMin), c.setValue(t), g = !i, c.focus(), g = !0, c.setSelection({
                    line: a,
                    ch: n
                }, {line: o, ch: r}), c.refresh(), c.clearHistory();
            } else {
        ...
        plugin: "codeView"
    }),Ee.FE.DefineIcon("html", {NAME: "code"}),Ee.extend(Ee.FE.POPUP_TEMPLATES, {"colors.picker": "[_BUTTONS_][_TEXT_COLORS_][_BACKGROUND_COLORS_][_CUSTOM_COLOR_]"}),Ee.extend(Ee.FE.DEFAULTS, {
        ...
        return {
            showColorsPopup: function () {
                var e = g.$tb.find('.fr-command[data-cmd="color"]'), t = g.popups.get("colors.picker");
                if (t || (t = function () {
                    ...
                    var h,
                        r = {buttons: t, text_colors: a("text"), background_colors: a("background"), custom_color: n},
                    ...
                    return h = i, g.events.on("popup.tab", function (e) {
                        ...
                        if (Ee.FE.KEYCODE.TAB == n) {
                            ...
                            if (t.is("span.fr-select-color")) {
                                var a = t.parent().find("span.fr-select-color"), o = a.index(t), s = g.opts.colorsStep,
                                    l = Math.floor(a.length / s), d = o % s, c = Math.floor(o / s), f = c * s + d,
                                    p = l * s;
                ...
                }()), !t.hasClass("fr-active")) if (g.popups.setContainer("colors.picker", g.$tb), i(t.find(".fr-selected-tab").attr("data-param1")), e.is(":visible")) {
            ...
            }, hideColorsPopup: t, changeSet: function (e, t) {
            ...
            }, background: r, customColor: function () {
                var e = g.popups.get("colors.picker"), t = e.find(".fr-color-hex-layer input");
                if (t.length) {
                    var n = t.val();
                    "background" == e.find(".fr-selected-tab").attr("data-param1") ? r(n) : o(n);
                }
            }, text: o, back: function () {
                g.popups.hide("colors.picker"), g.toolbar.showInline();
            }
        };
    },Ee.FE.DefineIcon("colors", {NAME: "tint"}),Ee.FE.RegisterCommand("color", {
        title: "Colors",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
        ...
        undo: !1, focus: !1, callback: function (e, t) {
            var n = this.popups.get("colors.picker").find('.fr-command[data-cmd="' + e + '"][data-param1="' + t + '"]');
            this.colors.changeSet(n, t);
        }
    }),Ee.FE.DefineIcon("colorsBack", {NAME: "arrow-left"}),Ee.FE.RegisterCommand("colorsBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }),Ee.FE.DefineIcon("remove", {NAME: "eraser"}),Ee.extend(Ee.FE.DEFAULTS, {dragInline: !0}),Ee.FE.PLUGINS.draggable = function (d) {
        function e(e) {
        ...
        function t(e) {
            e.originalEvent.dataTransfer.dropEffect = "move", d.opts.dragInline ? function () {
                for (var e = null, t = 0; t < Ee.FE.INSTANCES.length; t++) if ((e = Ee.FE.INSTANCES[t].$el.find(".fr-dragging")).length) return e.get(0);
        ...
        function i(e) {
            for (var t, n, r = 0; r < Ee.FE.INSTANCES.length; r++) if ((t = Ee.FE.INSTANCES[r].$el.find(".fr-dragging")).length) {
                n = Ee.FE.INSTANCES[r];
                break;
            }
            if (t.length) {
        ...
        function a(e) {
            if (e && "DIV" == e.tagName && d.node.hasClass(e, "fr-drag-helper")) e.parentNode.removeChild(e); else if (e && e.nodeType == Node.ELEMENT_NODE) for (var t = e.querySelectorAll("div.fr-drag-helper"), n = 0; n < t.length; n++) t[n].parentNode.removeChild(t[n]);
        }
    ...
    },Ee.extend(Ee.FE.POPUP_TEMPLATES, {emoticons: "[_BUTTONS_][_EMOTICONS_]"}),Ee.extend(Ee.FE.DEFAULTS, {
        emoticonsStep: 8,
        ...
        function i() {
            ...
            var e = m.selection.element(), t = m.selection.endElement();
            if (e && m.node.hasClass(e, "fr-emoticon")) return e;
            if (t && m.node.hasClass(t, "fr-emoticon")) return t;
            var n = m.selection.ranges(0), r = n.startContainer;
            ...
            _init: function () {
                ...
                e(), m.events.on("html.set", e), m.events.on("keydown", function (e) {
                    if (m.keys.isCharacter(e.which) && m.selection.inEditor()) {
                        var t = m.selection.ranges(0), n = i();
                ...
                var n = i(), r = m.selection.ranges(0);
                ...
                var e = m.$tb.find('.fr-command[data-cmd="emoticons"]'), t = m.popups.get("emoticons");
                if (t || (t = function () {
                    var e = "";
                    ...
                    var g, t = {
                        buttons: e, emoticons: function () {
                            ...
                            return m.opts.emoticonsUseImage && (e += '<p style="font-size: 12px; text-align: center; padding: 0 5px;">Emoji free by <a class="fr-link" tabIndex="-1" href="http://emojione.com/" target="_blank" rel="nofollow" role="link" aria-label="Open Emoji One website.">Emoji One</a></p>'), e += "</div>";
                        }()
                    ...
                    return m.tooltip.bind(n, ".fr-emoticon"), g = n, m.events.on("popup.tab", function (e) {
                        ...
                        if (Ee.FE.KEYCODE.TAB == a) {
                            ...
                            if (t.is("span.fr-emoticon")) {
                                ...
                                r = l.index(t);
                                var d = m.opts.emoticonsStep, c = Math.floor(l.length / d), f = r % d,
                                    p = Math.floor(r / d), u = p * d + f, h = c * d;
    ...
    }),Ee.FE.DefineIcon("emoticonsBack", {NAME: "arrow-left"}),Ee.FE.RegisterCommand("emoticonsBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        return {
            _init: function () {
                ...
                var e = Ee("<div>").html(i.opts.entities).text(), t = i.opts.entities.split(";");
                o = {}, a = "";
                for (var n = 0; n < e.length; n++) {
                    var r = e.charAt(n);
    ...
    },Ee.extend(Ee.FE.POPUP_TEMPLATES, {"file.insert": "[_BUTTONS_][_UPLOAD_LAYER_][_PROGRESS_BAR_]"}),Ee.extend(Ee.FE.DEFAULTS, {
        fileUpload: !0,
    ...
    }),Ee.FE.PLUGINS.file = function (l) {
        var r, d = 2, c = 3, f = 4, s = 5, p = 6, n = {};
        ...
        function g(e) {
            var t = this.status, n = this.response, r = this.responseXML, i = this.responseText;
            try {
                if (l.opts.fileUploadToS3) if (201 == t) {
                    var a = function (e) {
                        try {
                            var t = Ee(e).find("Location").text(), n = Ee(e).find("Key").text();
        ...
        function m() {
            E(f, this.response || this.responseText || this.responseXML);
        }
        ...
        function o(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if (l.drag_support.formdata && (t = l.drag_support.formdata ? new FormData : null), t) {
                    ...
                    a.onload = function () {
                        g.call(a, n.name);
                    }, a.onerror = m, a.upload.onprogress = v, a.onabort = b, u();
        ...
        function A(e) {
            ...
            return r = a, l.events.$on(r, "dragover dragenter", ".fr-file-upload-layer", function () {
                ...
                this.files && (r.data("instance") || l).file.upload(this.files), Ee(this).val("");
            }, !0), a;
        }
        ...
        function C() {
            var e, t = Array.prototype.slice.call(l.el.querySelectorAll("a.fr-file")), n = [];
            for (e = 0; e < t.length; e++) n.push(t[e].getAttribute("href"));
            if (r) for (e = 0; e < r.length; e++) n.indexOf(r[e].getAttribute("href")) < 0 && l.events.trigger("file.unlink", [r[e]]);
            r = t;
        }
        ...
        return n[1] = "File cannot be loaded from the passed link.", n[d] = "No link in upload response.", n[c] = "Error during file upload.", n[f] = "Parsing response failed.", n[s] = "File is too large.", n[p] = "File file type is invalid.", n[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", {
            _init: function () {
                l.events.on("drop", t), l.events.$on(l.$win, "keydown", function (e) {
                    var t = e.which, n = l.popups.get("file.insert");
                ...
                if (t || (t = A()), i(), !t.hasClass("fr-active")) if (l.popups.refresh("file.insert"), l.popups.setContainer("file.insert", l.$tb), e.is(":visible")) {
                    var n = e.offset().left + e.outerWidth() / 2,
            ...
            }, upload: o, insert: h, back: function () {
        ...
        plugin: "file"
    }),Ee.FE.DefineIcon("fileBack", {NAME: "arrow-left"}),Ee.FE.RegisterCommand("fileBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        function s() {
            var e = a(Ee(i.selection.element()).css("font-family")), t = [];
            for (var n in i.opts.fontFamily) if (i.opts.fontFamily.hasOwnProperty(n)) {
                var r = o(e, a(n));
                r && t.push([n, r]);
            }
    ...
    }),Ee.FE.DefineIcon("fontFamily", {NAME: "font"}),Ee.extend(Ee.FE.DEFAULTS, {
        ...
        return {
            apply: function (e) {
                ...
                var r = t.find(".fr-dropdown-list"), i = t.find(".fr-active").parent();
    ...
    }),Ee.FE.DefineIcon("fontSize", {NAME: "text-height"}),Ee.extend(Ee.FE.POPUP_TEMPLATES, {
        ...
        function l(e) {
            ...
            t || (t = function () {
                ...
                var t = {buttons: e}, n = a.popups.create("forms.edit", t);
        ...
        function d() {
            var e = a.popups.get("forms.update"), t = s();
            if (t) {
                var n = Ee(t);
        ...
        return {
            _init: function () {
                ...
                var e = a.popups.get("forms.update"), t = s();
                if (t) {
                    var n = Ee(t), r = e.find('input[type="text"][name="text"]').val() || "";
                    r.length && (n.is("button") ? n.text(r) : n.attr("placeholder", r)), a.popups.hide("forms.update"), l(t);
                }
            }, getInput: s, applyStyle: function (e, t, n) {
                ...
                var e = s();
                if (e) {
                    var t = Ee(e), n = a.popups.get("forms.update");
    ...
    }),Ee.FE.DefineIcon("inputStyle", {NAME: "magic"}),Ee.FE.RegisterCommand("inputStyle", {
        title: "Style",
        type: "dropdown",
        html: function () {
    ...
    }),Ee.FE.DefineIcon("inputEdit", {NAME: "edit"}),Ee.FE.RegisterCommand("inputEdit", {
        title: "Edit Button",
        undo: !1,
        refreshAfterCallback: !1,
        callback: function () {
    ...
    }),Ee.FE.DefineIcon("inputBack", {NAME: "arrow-left"}),Ee.FE.RegisterCommand("inputBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        plugin: "fullscreen"
    }),Ee.FE.DefineIcon("fullscreen", {NAME: "expand"}),Ee.FE.DefineIcon("fullscreenCompress", {NAME: "compress"}),Ee.extend(Ee.FE.DEFAULTS, {
        helpSets: [{
            title: "Inline Editor",
        ...
        return {
            _init: function () {
                ...
                if (!r) {
                    var e = "<h4>" + o.language.translate("Shortcuts") + "</h4>", t = function () {
                        for (var e = '<div class="fr-help-modal">', t = 0; t < o.opts.helpSets.length; t++) {
                            var n = o.opts.helpSets[t], r = "<table>";
    ...
    },Ee.FroalaEditor.DefineIcon("help", {NAME: "question"}),Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.SLASH, "help", null, "/"),Ee.FE.RegisterCommand("help", {
        title: "Help",
        icon: "help",
        undo: !1,
        focus: !1,
    ...
    }),Ee.FE.PLUGINS.image = function (c) {
        var f, l, d, p, s, n, t = !1, r = 1, u = 2, h = 3, g = 4, o = 5, m = 6, v = 8, i = {};
        ...
        function a() {
            ...
            if (e || (e = x()), e) {
                ...
                var n = t.offset().left + t.outerWidth() / 2, r = t.offset().top + t.outerHeight();
        ...
        function e() {
            for (var e, t, n = "IMG" == c.el.tagName ? [c.el] : c.el.querySelectorAll("img"), r = 0; r < n.length; r++) {
                var i = Ee(n[r]);
                !c.opts.htmlUntouched && c.opts.useClasses ? ((c.opts.imageDefaultAlign || c.opts.imageDefaultDisplay) && (0 < (t = i).parents(".fr-img-caption").length && (t = t.parents(".fr-img-caption:first")), t.hasClass("fr-dii") || t.hasClass("fr-dib") || (t.addClass("fr-fi" + fe(t)[0]), t.addClass("fr-di" + pe(t)[0]), t.css("margin", ""), t.css("float", ""), t.css("display", ""), t.css("z-index", ""), t.css("position", ""), t.css("overflow", ""), t.css("vertical-align", ""))), c.opts.imageTextNear || (0 < i.parents(".fr-img-caption").length ? i.parents(".fr-img-caption:first").removeClass("fr-dii").addClass("fr-dib") : i.removeClass("fr-dii").addClass("fr-dib"))) : c.opts.htmlUntouched || c.opts.useClasses || (c.opts.imageDefaultAlign || c.opts.imageDefaultDisplay) && (0 < (e = i).parents(".fr-img-caption").length && (e = e.parents(".fr-img-caption:first")), ce(e, e.hasClass("fr-dib") ? "block" : e.hasClass("fr-dii") ? "inline" : null, e.hasClass("fr-fil") ? "left" : e.hasClass("fr-fir") ? "right" : fe(e)), e.removeClass("fr-dib fr-dii fr-fir fr-fil")), c.opts.iframe && i.on("load", c.size.syncIframe);
            }
        }

        function T(e) {
            void 0 === e && (e = !0);
            var t, n = Array.prototype.slice.call(c.el.querySelectorAll("img")), r = [];
            for (t = 0; t < n.length; t++) if (r.push(n[t].getAttribute("src")), Ee(n[t]).toggleClass("fr-draggable", c.opts.imageMove), "" === n[t].getAttribute("class") && n[t].removeAttribute("class"), "" === n[t].getAttribute("style") && n[t].removeAttribute("style"), n[t].parentNode && n[t].parentNode.parentNode && c.node.hasClass(n[t].parentNode.parentNode, "fr-img-caption")) {
            ...
            if (s) for (t = 0; t < s.length; t++) r.indexOf(s[t].getAttribute("src")) < 0 && c.events.trigger("image.removed", [Ee(s[t])]);
            if (s && e) {
                var o = [];
                for (t = 0; t < s.length; t++) o.push(s[t].getAttribute("src"));
                for (t = 0; t < n.length; t++) o.indexOf(n[t].getAttribute("src")) < 0 && c.events.trigger("image.loaded", [Ee(n[t])]);
            }
            s = n;
        }
        ...
        function A() {
            if (l || function () {
                var e;
                c.shared.$image_resizer ? (l = c.shared.$image_resizer, p = c.shared.$img_overlay, c.events.on("destroy", function () {
                    l.removeClass("fr-active").appendTo(Ee("body:first"));
                }, !0)) : (c.shared.$image_resizer = Ee('<div class="fr-image-resizer"></div>'), l = c.shared.$image_resizer, c.events.$on(l, "mousedown", function (e) {
                    e.stopPropagation();
                }, !0), c.opts.imageResize && (l.append(C("nw") + C("ne") + C("sw") + C("se")), c.shared.$img_overlay = Ee('<div class="fr-image-overlay"></div>'), p = c.shared.$img_overlay, e = l.get(0).ownerDocument, Ee(e).find("body:first").append(p)));
                c.events.on("shared.destroy", function () {
                    l.html("").removeData().remove(), l = null, c.opts.imageResize && (p.remove(), p = null);
                }, !0), c.helpers.isMobile() || c.events.$on(Ee(c.o_win), "resize", function () {
                    f && !f.hasClass("fr-uploading") ? oe(!0) : f && (A(), ue(), N(!1));
                });
                if (c.opts.imageResize) {
                    ...
                    c.events.on("keydown", function (e) {
                        if (f) {
                            var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey, n = e.which;
        ...
        function S(e) {
            ve() ? f.parents(".fr-img-caption").css("width", e) : f.css("width", e);
        }
        ...
        function R(e) {
            ...
            if ("mousedown" == e.type) {
                var n = c.$oel.get(0).ownerDocument, r = n.defaultView || n.parentWindow, i = !1;
                try {
        ...
        function y(e) {
            ...
            if (d && f) {
                ...
                if (!n) return !1;
                var r = n - d.data("start-x"), i = d.data("start-width");
        ...
        function L(e, t, n) {
            c.edit.on(), f && f.addClass("fr-error"), function (e) {
                N();
                var t = c.popups.get("image.insert").find(".fr-image-progress-bar-layer");
                t.addClass("fr-error");
                var n = t.find("h3");
                n.text(e), c.events.disableBlur(), n.focus();
            }(c.language.translate("Something went wrong. Please try again.")), !f && n && Q(n), c.events.trigger("image.error", [{
                code: e,
                message: i[e]
            }, t, n]);
        }
        ...
        function x(e) {
            if (e) return c.$wp && c.events.$on(c.$wp, "scroll", function () {
                f && c.popups.isVisible("image.edit") && (c.events.disableBlur(), I(f));
            }), !0;
            var t = "";
            if (0 < c.opts.imageEditButtons.length) {
                t += '<div class="fr-buttons">', t += c.button.buildList(c.opts.imageEditButtons);
                var n = {buttons: t += "</div>"};
                return c.popups.create("image.edit", n);
            }
            return !1;
        }
        ...
        function N(e) {
            ...
            if (t || (t = W()), t.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").addClass("fr-active"), t.find(".fr-buttons").hide(), f) {
                ...
                var r = n.offset().left + n.width() / 2, i = n.offset().top + n.height();
        ...
        function k(o, e, s, l, d) {
            ...
            t.onload = function () {
                ...
                if (l) {
                    ...
                    if (void 0 !== s) for (t in s) s.hasOwnProperty(t) && "link" != t && e.attr("data-" + t, s[t]);
                ...
                L(r);
            }, N(c.language.translate("Loading image")), t.src = o;
        }
        ...
        function F(e) {
            ...
            var t = this.status, n = this.response, r = this.responseXML, i = this.responseText;
            try {
                if (c.opts.imageUploadToS3) if (201 == t) {
                    var a = function (e) {
                        try {
                            var t = Ee(e).find("Location").text(), n = Ee(e).find("Key").text();
                    ...
                    a && k(a, !1, [], e, n || r);
                } else L(g, n || r, e); else if (200 <= t && t < 300) {
                    var o = function (e) {
                        try {
                            if (!1 === c.events.trigger("image.uploaded", [e], !0)) return c.edit.on(), !1;
                            var t = JSON.parse(e);
                            return t.link ? t : (L(u, e), !1);
                        } catch (n) {
                            return L(g, e), !1;
                        }
                    }(i);
        ...
        function M() {
            L(g, this.response || this.responseText || this.responseXML);
        }
        ...
        function B(e, t, n) {
            var r, i = "";
            if (t && void 0 !== t) for (r in t) t.hasOwnProperty(r) && "link" != r && (i += " data-" + r + '="' + t[r] + '"');
            var a = c.opts.imageDefaultWidth;
            a && "auto" != a && (a += c.opts.imageResizeWithPercent ? "%" : "px");
            var o = Ee('<img src="' + e + '"' + i + (a ? ' style="width: ' + a + ';"' : "") + ">");
            ce(o, c.opts.imageDefaultDisplay, c.opts.imageDefaultAlign), o.on("load", n), o.on("error", function () {
                Ee(this).addClass("fr-error"), L(v);
            }), c.edit.on(), c.events.focus(!0), c.selection.restore(), c.undo.saveStep(), c.opts.imageSplitHTML ? c.markers.split() : c.markers.insert(), c.html.wrap();
        ...
        function K(e, t) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if (c.drag_support.formdata && (n = c.drag_support.formdata ? new FormData : null), n) {
                    ...
                    c.opts.imageUploadToS3 && (a = c.opts.imageUploadToS3.uploadURL ? c.opts.imageUploadToS3.uploadURL : "https://" + c.opts.imageUploadToS3.region + ".amazonaws.com/" + c.opts.imageUploadToS3.bucket), function (t, n, e, i) {
                        function a() {
                            var e = Ee(this);
                            e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), c.placeholder.refresh(), I(e), A(), N(), c.edit.off(), t.onload = function () {
                                F.call(t, e);
                        ...
                        o.addEventListener("load", function () {
                            ...
                            i ? (i.on("load", a), i.one("error", function () {
                                i.off("load"), i.attr("src", i.data("fr-old-src")), L(v);
                            }), c.edit.on(), c.undo.saveStep(), i.data("fr-old-src", i.attr("src")), i.attr("src", e)) : B(e, null, a);
                        }, !1), o.readAsDataURL(e);
        ...
        function H(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (n && n.type && -1 !== n.type.indexOf("image") && 0 <= c.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, ""))) {
                    ...
                    var i = e.originalEvent.pageX, a = e.originalEvent.pageY;
        ...
        function W(e) {
            ...
            var r = c.opts.imageInsertButtons.indexOf("imageUpload"),
                i = c.opts.imageInsertButtons.indexOf("imageByURL"), a = "";
            ...
            return c.$wp && c.events.$on(c.$wp, "scroll", function () {
                f && c.popups.isVisible("image.insert") && ue();
            }), s = d, c.events.$on(s, "dragover dragenter", ".fr-image-upload-layer", function () {
                return Ee(this).addClass("fr-drop"), !1;
            }, !0), c.events.$on(s, "dragleave dragend", ".fr-image-upload-layer", function () {
                return Ee(this).removeClass("fr-drop"), !1;
            }, !0), c.events.$on(s, "drop", ".fr-image-upload-layer", function (e) {
                e.preventDefault(), e.stopPropagation(), Ee(this).removeClass("fr-drop");
                var t = e.originalEvent.dataTransfer;
                if (t && t.files) {
            ...
            }, !0), c.helpers.isIOS() && c.events.$on(s, "touchstart", '.fr-image-upload-layer input[type="file"]', function () {
                Ee(this).trigger("click");
            }, !0), c.events.$on(s, "change", '.fr-image-upload-layer input[type="file"]', function () {
                if (this.files) {
        ...
        function z() {
            f && c.popups.get("image.alt").find("input").val(f.attr("alt") || "").trigger("change");
        }
        ...
        function G(e) {
            ...
            var t = {
                buttons: '<div class="fr-buttons">' + c.button.buildList(c.opts.imageAltButtons) + "</div>",
            ...
            return c.$wp && c.events.$on(c.$wp, "scroll.image-alt", function () {
                f && c.popups.isVisible("image.alt") && Y();
            }), n;
        }
        ...
        function q(e) {
            ...
            var t = {
                buttons: '<div class="fr-buttons">' + c.button.buildList(c.opts.imageSizeButtons) + "</div>",
                size_layer: '<div class="fr-image-size-layer fr-layer fr-active" id="fr-image-size-layer-' + c.id + '"><div class="fr-image-group"><div class="fr-input-line"><input id="fr-image-size-layer-width-' + c.id + '" type="text" name="width" placeholder="' + c.language.translate("Width") + '" tabIndex="1"></div><div class="fr-input-line"><input id="fr-image-size-layer-height' + c.id + '" type="text" name="height" placeholder="' + c.language.translate("Height") + '" tabIndex="1"></div></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-submit" data-cmd="imageSetSize" tabIndex="2" role="button">' + c.language.translate("Update") + "</button></div></div>"
            }, n = c.popups.create("image.size", t);
            return c.$wp && c.events.$on(c.$wp, "scroll.image-size", function () {
                f && c.popups.isVisible("image.size") && X();
            }), n;
        }
        ...
        function Z(e) {
            var t = e.which;
            if (f && (t == Ee.FE.KEYCODE.BACKSPACE || t == Ee.FE.KEYCODE.DELETE)) return e.preventDefault(), e.stopPropagation(), Q(), !1;
            if (f && t == Ee.FE.KEYCODE.ESC) {
                var n = f;
                return oe(!0), c.selection.setAfter(n.get(0)), c.selection.restore(), e.preventDefault(), !1;
            }
            if (f && (t == Ee.FE.KEYCODE.ARROW_LEFT || t == Ee.FE.KEYCODE.ARROW_RIGHT)) {
                var r = f.get(0);
                return oe(!0), t == Ee.FE.KEYCODE.ARROW_LEFT ? c.selection.setBefore(r) : c.selection.setAfter(r), c.selection.restore(), e.preventDefault(), !1;
            }
            return f && t != Ee.FE.KEYCODE.F10 && !c.keys.isBrowserAction(e) ? (e.preventDefault(), e.stopPropagation(), !1) : void 0;
        }
        ...
        function J(e) {
            ...
            } else if (e && e.nodeType == Node.ELEMENT_NODE) for (var r = e.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), i = 0; i < r.length; i++) J(r[i]);
        }
        ...
        function te() {
            c.opts.imagePaste ? c.$el.find("img[data-fr-image-pasted]").each(function (e, n) {
                ...
                if (0 === n.src.indexOf("data:")) ee(n); else if (0 === n.src.indexOf("blob:") || 0 === n.src.indexOf("http") && c.opts.imageUploadRemoteUrls && c.opts.imageCORSProxy) {
                    var r = new Image;
                    r.crossOrigin = "Anonymous", r.onload = function () {
                        var e = c.o_doc.createElement("CANVAS"), t = e.getContext("2d");
        ...
        function ne(e) {
            var t = e.target.result, n = c.opts.imageDefaultWidth;
        ...
        function oe(e) {
            f && (se || !0 === e) && (c.toolbar.enable(), l.removeClass("fr-active"), c.popups.hide("image.edit"), f = null, de(), d = null, p && p.hide());
        }
        ...
        function ce(e, t, n) {
            !c.opts.htmlUntouched && c.opts.useClasses ? (e.removeClass("fr-fil fr-fir fr-dib fr-dii"), n && e.addClass("fr-fi" + n[0]), t && e.addClass("fr-di" + t[0])) : "inline" == t ? (e.css({
                ...
                marginBottom: "",
                marginTop: "",
                maxWidth: "calc(100% - " + 2 * c.opts.imageDefaultMargin + "px)",
                textAlign: "center"
            }) : "left" == n ? e.css({
                "float": "left",
                marginLeft: 0,
                maxWidth: "calc(100% - " + c.opts.imageDefaultMargin + "px)",
                textAlign: "left"
            }) : e.css({
                "float": "right",
                marginRight: 0,
                ...
                "float": "none",
                verticalAlign: "top",
                margin: c.opts.imageDefaultMargin + "px auto",
                textAlign: "center"
        ...
        function me() {
            return ve() ? f.parents(".fr-img-caption:first") : f;
        }
        ...
        return {
            _init: function () {
                ...
                c.events.$on(c.$el, c._mousedown, "IMG" == c.el.tagName ? null : 'img:not([contenteditable="false"])', function (e) {
                    ...
                    if (e.shiftKey && "" === c.selection.text().replace(/\n/g, "") && c.keys.isArrow(e.which)) {
                        var t = c.selection.element(), n = c.selection.endElement();
                    ...
                    f && (he(), c.selection.clear());
                }), "IMG" == c.el.tagName && c.$el.addClass("fr-view"), c.events.$on(c.$el, c.helpers.isMobile() && !c.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == c.el.tagName ? null : 'img:not([contenteditable="false"])', ae), c.helpers.isMobile() && (c.events.$on(c.$el, "touchstart", "IMG" == c.el.tagName ? null : 'img:not([contenteditable="false"])', function () {
                    n = !1;
                }), c.events.$on(c.$el, "touchmove", function () {
                    n = !0;
                })), c.$wp ? (c.events.on("window.keydown keydown", Z, !0), c.events.on("keyup", function (e) {
                    if (f && e.which == Ee.FE.KEYCODE.ENTER) return !1;
                }, !0)) : c.events.$on(c.$win, "keydown", Z), c.events.on("toolbar.esc", function () {
                    if (f) {
                        if (c.$wp) c.events.disableBlur(), c.events.focus(); else {
                            var e = f;
                    ...
                    if (f) return !1;
                }, !0), c.events.on("window.cut window.copy", function (e) {
                    if (f && c.popups.isVisible("image.edit") && !c.popups.get("image.edit").find(":focus").length) {
                        var t = me();
                        ve() ? (t.before(Ee.FE.START_MARKER), t.after(Ee.FE.END_MARKER), c.selection.restore(), c.paste.saveCopiedText(t.get(0).outerHTML, t.text())) : (he(), c.paste.saveCopiedText(f.get(0).outerHTML, f.attr("alt"))), "copy" == e.type ? setTimeout(function () {
                            I(f);
                        }) : (oe(!0), c.undo.saveStep(), setTimeout(function () {
                            c.undo.saveStep();
                        }, 0));
                    }
                ...
                }), c.events.$on(Ee(c.o_win), "keydown", function (e) {
                    var t = e.which;
                    if (f && t == Ee.FE.KEYCODE.BACKSPACE) return e.preventDefault(), !1;
                }), c.events.$on(c.$win, "keydown", function (e) {
                    var t = e.which;
                ...
                }), c.events.on("paste.before", re), c.events.on("paste.beforeCleanup", ie), c.events.on("paste.after", te), c.events.on("html.set", e), c.events.on("html.inserted", e), e(), c.events.on("destroy", function () {
                    s = [];
                }), c.events.on("html.processGet", J), c.opts.imageOutputSize && c.events.on("html.beforeGet", function () {
                    r = c.el.querySelectorAll("img");
                    for (var e = 0; e < r.length; e++) {
                        var t = r[e].style.width || Ee(r[e]).width(), n = r[e].style.height || Ee(r[e]).height();
                        t && r[e].setAttribute("width", ("" + t).replace(/px/, "")), n && r[e].setAttribute("height", ("" + n).replace(/px/, ""));
                    }
                }), c.opts.iframe && c.events.on("image.loaded", c.size.syncIframe), c.$wp && (T(), c.events.on("contentChanged", T)), c.events.$on(Ee(c.o_win), "orientationchange.image", function () {
                    setTimeout(function () {
                        f && I(f);
                    }, 100);
                }), x(!0), W(!0), q(!0), G(!0), c.events.on("node.remove", function (e) {
                    if ("IMG" == e.get(0).tagName) return Q(e), !1;
                });
            },
            showInsertPopup: function () {
                var e = c.$tb.find('.fr-command[data-cmd="insertImage"]'), t = c.popups.get("image.insert");
                if (t || (t = W()), O(), !t.hasClass("fr-active")) if (c.popups.refresh("image.insert"), c.popups.setContainer("image.insert", c.$tb), e.is(":visible")) {
                    var n = e.offset().left + e.outerWidth() / 2,
            ...
            refreshUploadButton: function (e) {
                c.popups.get("image.insert").find(".fr-image-upload-layer").hasClass("fr-active") && e.addClass("fr-active").attr("aria-pressed", !0);
            },
            refreshByURLButton: function (e) {
                c.popups.get("image.insert").find(".fr-image-by-url-layer").hasClass("fr-active") && e.addClass("fr-active").attr("aria-pressed", !0);
            },
            upload: K,
            insertByURL: function () {
                ...
                if (0 < e.val().length) {
                    ...
                    if (c.opts.imageUploadRemoteUrls && c.opts.imageCORSProxy && c.opts.imageUpload) {
                        var n = new XMLHttpRequest;
                        n.onload = function () {
                            200 == this.status ? K([new Blob([this.response], {type: this.response.type || "image/png"})], f) : L(r);
                        }, n.onerror = function () {
                            k(t, !0, [], f);
                        }, n.open("GET", c.opts.imageCORSProxy + "/" + t, !0), n.responseType = "blob", n.send();
                    } else k(t, !0, [], f);
                    e.val(""), e.blur();
                }
            },
            ...
            refreshAlign: function (e) {
                f && e.find("> *:first").replaceWith(c.icon.create("image-align-" + fe()));
            },
            refreshAlignOnShow: function (e, t) {
                f && t.find('.fr-command[data-param1="' + fe() + '"]').addClass("fr-active").attr("aria-selected", !0);
            },
            display: function (e) {
                var t = me();
            ...
            refreshDisplayOnShow: function (e, t) {
                f && t.find('.fr-command[data-param1="' + pe() + '"]').addClass("fr-active").attr("aria-selected", !0);
            },
            replace: ue,
            back: function () {
                f ? (c.events.disableBlur(), Ee(".fr-popup input:focus").blur(), I(f)) : (c.events.disableBlur(), c.selection.restore(), c.events.enableBlur(), c.popups.hide("image.insert"), c.toolbar.showInline());
            },
            get: ge,
            getEl: me,
            insert: k,
    ...
    },Ee.FE.DefineIcon("insertImage", {NAME: "image"}),Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.P, "insertImage", null, "P"),Ee.FE.RegisterCommand("insertImage", {
        title: "Insert Image",
        undo: !1,
        focus: !0,
        refreshAfterCallback: !1,
        ...
        plugin: "image"
    }),Ee.FE.DefineIcon("imageUpload", {NAME: "upload"}),Ee.FE.RegisterCommand("imageUpload", {
        title: "Upload Image",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }),Ee.FE.DefineIcon("imageByURL", {NAME: "link"}),Ee.FE.RegisterCommand("imageByURL", {
        title: "By URL",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }),Ee.FE.DefineIcon("imageDisplay", {NAME: "star"}),Ee.FE.RegisterCommand("imageDisplay", {
        title: "Display",
        type: "dropdown",
    ...
    }),Ee.FE.DefineIcon("image-align", {NAME: "align-left"}),Ee.FE.DefineIcon("image-align-left", {NAME: "align-left"}),Ee.FE.DefineIcon("image-align-right", {NAME: "align-right"}),Ee.FE.DefineIcon("image-align-center", {NAME: "align-justify"}),Ee.FE.DefineIcon("imageAlign", {NAME: "align-justify"}),Ee.FE.RegisterCommand("imageAlign", {
        type: "dropdown",
        title: "Align",
        options: {left: "Align Left", center: "None", right: "Align Right"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Ee.FE.COMMANDS.imageAlign.options;
    ...
    }),Ee.FE.DefineIcon("imageRemove", {NAME: "trash"}),Ee.FE.RegisterCommand("imageRemove", {
        title: "Remove",
        callback: function () {
            this.image.remove();
        }
    }),Ee.FE.DefineIcon("imageBack", {NAME: "arrow-left"}),Ee.FE.RegisterCommand("imageBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }),Ee.FE.DefineIcon("imageStyle", {NAME: "magic"}),Ee.FE.RegisterCommand("imageStyle", {
        title: "Style",
        type: "dropdown",
        html: function () {
        ...
        refreshOnShow: function (e, t) {
            ...
            n && t.find(".fr-command").each(function () {
                var e = Ee(this).data("param1"), t = n.hasClass(e);
                Ee(this).toggleClass("fr-active", t).attr("aria-selected", t);
            });
        }
    }),Ee.FE.DefineIcon("imageAlt", {NAME: "info"}),Ee.FE.RegisterCommand("imageAlt", {
        undo: !1,
        focus: !1,
        popup: !0,
    ...
    }),Ee.FE.DefineIcon("imageSize", {NAME: "arrows-alt"}),Ee.FE.RegisterCommand("imageSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
        ...
        var l, d, r, i, a, c, o, f, p, u, h, g = "image_manager", e = 10, m = 11, v = 12, E = 13, b = 14, T = 15,
            A = 21, C = 22, n = {};
        ...
        function R() {
            a.empty();
            for (var e = 0; e < h; e++) a.append('<div class="fr-list-column"></div>');
        }
        ...
        function y() {
            if (p < o.length && (a.outerHeight() <= r.outerHeight() + s.opts.imageManagerScrollOffset || r.scrollTop() + s.opts.imageManagerScrollOffset > a.outerHeight() - r.outerHeight())) {
                f++;
                for (var e = s.opts.imageManagerPageSize * (f - 1); e < Math.min(o.length, s.opts.imageManagerPageSize * f); e++) t(o[e]);
            }
        }
        ...
        function t(i) {
            ...
            N(!1), a.onload = function () {
                ...
                o.append(n).append(Ee(s.icon.create("imageManagerDelete")).addClass("fr-delete-img").attr("title", s.language.translate("Delete"))).append(Ee(s.icon.create("imageManagerInsert")).addClass("fr-insert-img").attr("title", s.language.translate("Insert"))), c.find(".fr-selected-tag").each(function (e, t) {
                    ...
                    o.removeClass("fr-empty"), o.height("auto"), p++, x(L(parseInt(n.parent().attr("class").match(/fr-image-(\d+)/)[1], 10) + 1)), N(!1), p % s.opts.imageManagerPageSize == 0 && y();
        ...
        function x(e) {
            for (var t = e.length - 1; 0 <= t; t--) _().append(e[t]);
        }
        ...
        function w(e) {
            var t = Ee(e.currentTarget).siblings("img"), n = l.data("instance") || s, r = l.data("current-image");
            if (s.modals.hide(g), n.image.showProgressBar(), r) r.data("fr-old-src", r.attr("src")), r.trigger("click"); else {
                ...
                var i = n.position.getBoundingRect(), a = i.left + i.width / 2 + Ee(s.doc).scrollLeft(),
        ...
        function I(e) {
            ...
            confirm(t) && (s.opts.imageManagerDeleteURL ? !1 !== s.events.trigger("imageManager.beforeDeleteImage", [n]) && (n.parent().addClass("fr-image-deleting"), Ee.ajax({
                ...
                data: Ee.extend(Ee.extend({src: n.attr("src")}, O(n)), s.opts.imageManagerDeleteParams),
                crossDomain: s.opts.requestWithCORS,
                xhrFields: {withCredentials: s.opts.requestWithCredentials},
        ...
        function k() {
            var e = d.find(".fr-modal-head-line").outerHeight(), t = c.outerHeight();
        ...
        return n[e] = "Image cannot be loaded from the passed link.", n[m] = "Error during load images request.", n[v] = "Missing imageManagerLoadURL option.", n[E] = "Parsing load response failed.", n[b] = "Missing image thumb.", n[T] = "Missing image URL.", n[A] = "Error during delete image request.", n[C] = "Missing imageManagerDeleteURL option.", {
            require: ["image"], _init: function () {
                ...
                })), s.events.bindClick(a, ".fr-insert-img", w), s.events.bindClick(a, ".fr-delete-img", I), l.on(s._mousedown + " " + s._mouseup, function (e) {
                    e.stopPropagation();
                }), l.on(s._mousedown, "*", function () {
                    s.events.disableBlur();
                }), r.on("scroll", y), s.events.bindClick(l, "i#fr-modal-more-" + s.sid, k), s.events.bindClick(c, "a", M)), i.show(), a.find(".fr-list-column").empty(), s.opts.imageManagerLoadURL ? Ee.ajax({
    ...
    Ee.FE.DEFAULTS.imageInsertButtons.push("imageManager"), Ee.FE.RegisterCommand("imageManager", {
        ...
        plugin: "imageManager"
    }), Ee.FE.DefineIcon("imageManager", {NAME: "folder"}), Ee.FE.DefineIcon("imageManagerInsert", {NAME: "plus"}), Ee.FE.DefineIcon("imageManagerDelete", {NAME: "trash"}), Ee.extend(Ee.FE.DEFAULTS, {
        inlineStyles: {
    ...
    }), Ee.FE.DefineIcon("inlineStyle", {NAME: "paint-brush"}), Ee.extend(Ee.FE.DEFAULTS, {
        ...
        function s(e, t) {
            ...
            if (null == e) o = (a = t.parent()).offset().top, n = (l = t.offset().top) - Math.min((l - o) / 2, p.opts.lineBreakerOffset), i = a.outerWidth(), r = a.offset().left; else if (null == t) (s = (a = e.parent()).offset().top + a.outerHeight()) < (d = e.offset().top + e.outerHeight()) && (s = (a = Ee(a).parent()).offset().top + a.outerHeight()), n = d + Math.min(Math.abs(s - d) / 2, p.opts.lineBreakerOffset), i = a.outerWidth(), r = a.offset().left; else {
                a = e.parent();
                var c = e.offset().top + e.height(), f = t.offset().top;
                if (f < c) return !1;
        ...
        function a(e, t) {
            ...
            return n && !Ee(n).closest(".fr-line-breaker").length && !p.node.isElement(n) && n != p.$wp.get(0) && function (e) {
                ...
                for (var t = e; e.parentNode && e.parentNode !== p.$wp.get(0);) e = e.parentNode;
                return t.inFroalaWrapper = e.parentNode == p.$wp.get(0), t.inFroalaWrapper;
            }(n) ? n : null;
        }

        function o(e, t, n) {
            for (var r = n, i = null; r <= p.opts.lineBreakerOffset && !i;) (i = a(e, t - r)) || (i = a(e, t + r)), r += n;
            return i;
        }

        function d(e, t, n) {
            for (var r = null, i = 100; !r && e > p.$box.offset().left && e < p.$box.offset().left + p.$box.outerWidth() && 0 < i;) (r = a(e, t)) || (r = o(e, t, 5)), "left" == n ? e -= p.opts.lineBreakerHorizontalOffset : e += p.opts.lineBreakerHorizontalOffset, i -= p.opts.lineBreakerHorizontalOffset;
            return r;
        }
        ...
        function n(e) {
            ...
            r && ("HTML" == r.tagName || "BODY" == r.tagName || p.node.isElement(r) || 0 <= (r.getAttribute("class") || "").indexOf("fr-line-breaker")) ? ((n = o(e.pageX - p.win.pageXOffset, e.pageY - p.win.pageYOffset, 1)) || (n = d(e.pageX - p.win.pageXOffset - p.opts.lineBreakerHorizontalOffset, e.pageY - p.win.pageYOffset, "left")), n || (n = d(e.pageX - p.win.pageXOffset + p.opts.lineBreakerHorizontalOffset, e.pageY - p.win.pageYOffset, "right")), t = l(n)) : t = l(r), t ? function (e, t) {
                var n, r, i = e.offset().top, a = e.offset().top + e.outerHeight();
                if (Math.abs(a - t) <= p.opts.lineBreakerOffset || Math.abs(t - i) <= p.opts.lineBreakerOffset) if (Math.abs(a - t) < Math.abs(t - i)) {
                    for (var o = (r = e.get(0)).nextSibling; o && o.nodeType == Node.TEXT_NODE && 0 === o.textContent.length;) o = o.nextSibling;
        ...
        function r() {
            i && clearTimeout(i), u.hasClass("fr-visible") && u.removeClass("fr-visible").removeData("instance");
        }
        ...
        function h(e) {
            ...
            u.removeClass("fr-visible").removeData("instance");
            var n = u.data("tag1"), r = u.data("tag2"), i = p.html.defaultTag();
        ...
        function p() {
            ...
            if (!e && f.$wp) {
                ...
                var n = f.selection.element(), r = f.selection.endElement();
        ...
        function u() {
            var e, t, n, r, i = f.image ? f.image.get() : null, a = [];
            if (i) "A" == i.get(0).parentNode.tagName && a.push(i.get(0).parentNode); else if (f.win.getSelection) {
                ...
                if (o.getRangeAt && o.rangeCount) {
                    r = f.doc.createRange();
                    for (var s = 0; s < o.rangeCount; ++s) if ((t = (e = o.getRangeAt(s)).commonAncestorContainer) && 1 != t.nodeType && (t = t.parentNode), t && "a" == t.nodeName.toLowerCase()) a.push(t); else {
                        n = t.getElementsByTagName("a");
                        for (var l = 0; l < n.length; ++l) r.selectNodeContents(n[l]), r.compareBoundaryPoints(e.END_TO_START, e) < 1 && -1 < r.compareBoundaryPoints(e.START_TO_END, e) && a.push(n[l]);
                    }
                }
                ...
                for (var d = 0; d < n.length; ++d) r.moveToElementText(n[d]), -1 < r.compareEndPoints("StartToEnd", e) && r.compareEndPoints("EndToStart", e) < 1 && a.push(n[d]);
            }
            return a;
        }
            ...
            if (f.core.hasFocus()) {
                ...
                setTimeout(function () {
                    if (!i || i && (1 == i.which || "mouseup" != i.type)) {
                        var e = p(), t = f.image ? f.image.get() : null;
                        if (e && !t) {
                            if (f.image) {
        ...
        function a(e) {
            ...
            t || (t = function () {
                ...
                var t = {buttons: e}, n = f.popups.create("link.edit", t);
            ...
            var r = n.offset().left + Ee(e).outerWidth() / 2, i = n.offset().top + n.outerHeight();
        ...
        function d() {
            var e = f.popups.get("link.insert"), t = p();
            if (t) {
                var n, r, i = Ee(t), a = e.find('input.fr-link-attr[type="text"]'),
        ...
        function g() {
            ...
            if (e) {
                ...
                var n = (f.image ? f.image.get() : null) || Ee(e), r = n.offset().left + n.outerWidth() / 2,
        ...
        function m() {
            ...
            if (e) {
                ...
                var n = e.offset().left + e.outerWidth() / 2, r = e.offset().top + e.outerHeight();
        ...
        return {
            _init: function () {
                ...
                var e = f.$tb.find('.fr-command[data-cmd="insertLink"]'), t = f.popups.get("link.insert");
                ...
                var t, n, r = f.opts.linkList[e], i = f.popups.get("link.insert"),
                    a = i.find('input.fr-link-attr[type="text"]'), o = i.find('input.fr-link-attr[type="checkbox"]');
                ...
                var e, t, n = f.popups.get("link.insert"), r = n.find('input.fr-link-attr[type="text"]'),
                    i = n.find('input.fr-link-attr[type="checkbox"]'),
                    a = (r.filter('[name="href"]').val() || "").trim(), o = r.filter('[name="text"]').val(), s = {};
            ...
            }, insert: c, update: g, get: p, allSelected: u, back: function () {
            ...
            }, imageLink: m, applyStyle: function (e, t, n) {
    ...
    }, Ee.FE.DefineIcon("insertLink", {NAME: "link"}), Ee.FE.RegisterShortcut(Ee.FE.KEYCODE.K, "insertLink", null, "K"), Ee.FE.RegisterCommand("insertLink", {
        title: "Insert Link",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
    ...
    }), Ee.FE.DefineIcon("linkEdit", {NAME: "edit"}), Ee.FE.RegisterCommand("linkEdit", {
        title: "Edit Link",
        undo: !1,
        refreshAfterCallback: !1,
        popup: !0,
        ...
        plugin: "link"
    }), Ee.FE.DefineIcon("linkRemove", {NAME: "unlink"}), Ee.FE.RegisterCommand("linkRemove", {
        title: "Unlink",
        callback: function () {
            this.link.remove();
        },
        ...
        plugin: "link"
    }), Ee.FE.DefineIcon("linkBack", {NAME: "arrow-left"}), Ee.FE.RegisterCommand("linkBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        plugin: "link"
    }), Ee.FE.DefineIcon("linkList", {NAME: "search"}), Ee.FE.RegisterCommand("linkList", {
        title: "Choose Link",
        type: "dropdown",
        focus: !1,
        undo: !1,
    ...
    }), Ee.FE.DefineIcon("imageLink", {NAME: "link"}), Ee.FE.RegisterCommand("imageLink", {
        title: "Insert Link",
        undo: !1,
        focus: !1,
        popup: !0,
        ...
        refreshOnShow: function (e, t) {
            ...
            if (n) {
                var r = Ee(n);
                t.find(".fr-command").each(function () {
                    var e = Ee(this).data("param1"), t = r.hasClass(e);
                    Ee(this).toggleClass("fr-active", t).attr("aria-selected", t);
                });
            }
        },
        ...
        function i(e) {
            var t, n;
            for (t = e.length - 1; 0 <= t; t--) for (n = t - 1; 0 <= n; n--) if (Ee(e[n]).find(e[t]).length || e[n] == e[t]) {
                e.splice(t, 1);
                break;
            }
            var r = [];
            for (t = 0; t < e.length; t++) {
                var i = Ee(e[t]), a = e[t].parentNode, o = i.attr("class");
            ...
            _init: function () {
                f.events.on("commands.after", e), f.events.on("keydown", function (e) {
                    if (e.which == Ee.FE.KEYCODE.TAB) {
                        ...
                        if (1 < n.length || n.length && (f.selection.info(n[0]).atStart || f.node.isEmpty(n[0]))) return e.preventDefault(), e.stopPropagation(), e.shiftKey ? o(n) : a(n), !1;
                    }
                }, !0);
            }, format: function (e) {
        ...
        title: "Unordered List", refresh: function (e) {
            this.lists.refresh(e, "UL");
        }, callback: function () {
            this.lists.format("UL");
        }, plugin: "lists"
    }), Ee.FE.RegisterCommand("formatOL", {
        title: "Ordered List", refresh: function (e) {
            this.lists.refresh(e, "OL");
        }, callback: function () {
            this.lists.format("OL");
        }, plugin: "lists"
    }), Ee.FE.DefineIcon("formatUL", {NAME: "list-ul"}), Ee.FE.DefineIcon("formatOL", {NAME: "list-ol"}), Ee.extend(Ee.FE.DEFAULTS, {
        paragraphFormat: {
            N: "Normal",
            H1: "Heading 1",
            H2: "Heading 2",
        ...
        return {
            apply: function (e) {
                ...
                for (var c = 0; c < d.length; c++) if (d[c].tagName != e && !p.node.isList(d[c])) {
                    var f = Ee(d[c]);
                ...
                if (n.length) {
                    var r = n[0], i = "N", a = p.html.defaultTag();
                ...
                if (p.opts.paragraphFormatSelection) {
                    ...
                    if (t.length) {
                        var n = t[0], r = "N", i = p.html.defaultTag();
    ...
    }), Ee.FE.DefineIcon("paragraphFormat", {NAME: "paragraph"}), Ee.extend(Ee.FE.DEFAULTS, {
        paragraphStyles: {
            "fr-text-gray": "Gray",
        ...
        return {
            run: function () {
                var e = i.$el.html(), t = null;
                i.shared.print_iframe ? t = i.shared.print_iframe : ((t = document.createElement("iframe")).name = "fr-print", t.style.position = "fixed", t.style.top = "0", t.style.left = "-9999px", t.style.height = "100%", t.style.width = "0", t.style.overflow = "hidden", t.style["z-index"] = "2147483647", t.style.tabIndex = "-1", document.body.appendChild(t), t.onload = function () {
                    setTimeout(function () {
                        i.events.disableBlur(), window.frames["fr-print"].focus(), window.frames["fr-print"].print(), i.$win.get(0).focus(), i.events.disableBlur(), i.events.focus();
                    }, 0);
                }, i.events.on("shared.destroy", function () {
                    t.remove();
                }), i.shared.print_iframe = t);
                var n = t.contentWindow;
                n.document.open(), n.document.write("<!DOCTYPE html><html><head><title>" + document.title + "</title>"), Array.prototype.forEach.call(document.querySelectorAll("style"), function (e) {
                    e = e.cloneNode(!0), n.document.write(e.outerHTML);
                });
    ...
    }, Ee.FE.DefineIcon("print", {NAME: "print"}), Ee.FE.RegisterCommand("print", {
        title: "Print",
        undo: !1,
        focus: !1,
        plugin: "print",
        ...
        Ee.FE.QUICK_INSERT_BUTTONS[e] = Ee.extend({undo: !0}, t);
        ...
        return {
            _init: function () {
                if (!o.$wp) return !1;
                o.opts.iframe && o.$el.parent("html").find("head").append('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.4.0/css/font-awesome.min.css">'), o.popups.onShow("image.edit", i), o.events.on("mouseup", r), o.helpers.isMobile() && o.events.$on(Ee(o.o_doc), "selectionchange", r), o.events.on("blur", i), o.events.on("keyup", r), o.events.on("keydown", function () {
                    setTimeout(function () {
                        r();
                    }, 0);
                });
        ...
        plugin: "quote"
    }), Ee.FE.DefineIcon("quote", {NAME: "quote-left"}), Ee.extend(Ee.FE.DEFAULTS, {
        saveInterval: 1e4,
        saveURL: null,
        saveParams: {},
        saveParam: "body",
        ...
        var e = null, l = null, t = !1, d = 1, c = 2, n = {};
        ...
        function r(e) {
            ...
            var t = e, n = s.events.trigger("save.before", [e]);
            if (!1 === n) return !1;
            if ("string" == typeof n && (e = n), s.opts.saveURL) {
                var r = {};
                for (var i in s.opts.saveParams) if (s.opts.saveParams.hasOwnProperty(i)) {
        ...
        return n[d] = "Missing saveURL option.", n[c] = "Something went wrong during save.", {
            ...
            }, save: r, reset: function () {
                i(), t = !1;
            }, force: function () {
                t = !0;
            }
        };
    }, Ee.FE.DefineIcon("save", {NAME: "floppy-o"}), Ee.FE.RegisterCommand("save", {
        title: "Save",
        undo: !1,
        focus: !1,
        refreshAfterCallback: !1,
        ...
        return {
            _init: function () {
                ...
                if (!o) {
                    var e = "<h4>" + s.language.translate("Special Characters") + "</h4>", t = function () {
                    ...
                    o = n.$modal, n.$head, l = n.$body, s.events.$on(Ee(s.o_win), "resize", function () {
                        ...
                        var t = o.data("instance") || s, n = Ee(e.currentTarget);
                        t.specialCharacters.insert(n);
                    }), s.events.$on(l, "keydown", function (e) {
                        var t = e.which, n = l.find("span.fr-special-character:focus:first");
        ...
        function u() {
            ...
            if (e) {
                ...
                if (t || (t = p()), t) {
                    ...
                    var n = O(e), r = (n.left + n.right) / 2, i = n.bottom;
        ...
        function d() {
            ...
            if (i) {
                ...
                a || (a = function () {
                    ...
                    return T.events.$on(T.$wp, "scroll.table-colors", function () {
                        ...
                        if (Ee.FE.KEYCODE.TAB == n) {
                            ...
                            var a = t.parent().find("span.fr-command"), o = a.index(t), s = T.opts.colorsStep,
                                l = Math.floor(a.length / s), d = o % s, c = Math.floor(o / s), f = c * s + d,
                                p = l * s;
                            Ee.FE.KEYCODE.ARROW_UP == n ? f = ((f - s) % p + p) % p : Ee.FE.KEYCODE.ARROW_DOWN == n ? f = (f + s) % p : Ee.FE.KEYCODE.ARROW_LEFT == n ? f = ((f - 1) % p + p) % p : Ee.FE.KEYCODE.ARROW_RIGHT == n && (f = (f + 1) % p);
                            var u = Ee(a.get(f));
                ...
                var o = O(i), s = (o.left + o.right) / 2, l = o.bottom;
            ...
            return T.events.$on(i, "mouseenter", ".fr-table-size .fr-select-table-size .fr-table-cell", function (e) {
                ...
                if (Ee.FE.KEYCODE.ARROW_UP == r || Ee.FE.KEYCODE.ARROW_DOWN == r || Ee.FE.KEYCODE.ARROW_LEFT == r || Ee.FE.KEYCODE.ARROW_RIGHT == r) {
                    if (t.is("span.fr-table-cell")) {
                        var i = t.parent().find("span.fr-table-cell"), a = i.index(t), o = T.opts.tableInsertMaxSize,
                            s = a % o, l = Math.floor(a / o);
        ...
        function f(e) {
            var t = e.data("row"), n = e.data("col"), r = e.parent();
            r.siblings(".fr-table-size-info").html(t + " &times; " + n), r.find("> span").removeClass("hover fr-active-item");
            for (var i = 1; i <= T.opts.tableInsertMaxSize; i++) for (var a = 0; a <= T.opts.tableInsertMaxSize; a++) {
        ...
        function g(e) {
            ...
            if (0 < t.length) {
                ...
                var s = "<tr>";
                for (n = 0; n < a[r].length; n++) if ("below" == e && r < a.length - 1 && a[r][n] == a[r + 1][n] || "above" == e && 0 < r && a[r][n] == a[r - 1][n]) {
        ...
        function m(e, t, n) {
            var r, i, a, o, s, l = 0, d = S(n);
            if (e < (t = Math.min(t, d[0].length - 1))) for (i = e; i <= t; i++) if (!(e < i && d[0][i] == d[0][i - 1]) && 1 < (o = Math.min(parseInt(d[0][i].getAttribute("colspan"), 10) || 1, t - e + 1)) && d[0][i] == d[0][i + 1]) for (l = o - 1, r = 1; r < d.length; r++) if (d[r][i] != d[r - 1][i]) {
        ...
        function v(e, t, n) {
            var r, i, a, o, s, l = 0, d = S(n);
            if (e < (t = Math.min(t, d.length - 1))) for (r = e; r <= t; r++) if (!(e < r && d[r][0] == d[r - 1][0]) && 1 < (o = Math.min(parseInt(d[r][0].getAttribute("rowspan"), 10) || 1, t - e + 1)) && d[r][0] == d[r + 1][0]) for (l = o - 1, i = 1; i < d[0].length; i++) if (d[r][i] != d[r][i - 1]) {
        ...
        function S(e) {
            ...
            return null == (e = e || null) && 0 < Q().length && (e = Z()), e && e.find("tr").not(e.find("table tr")).each(function (s, e) {
                ...
                t.find("> th, > td").each(function (e, t) {
                    for (var n = Ee(t), r = parseInt(n.attr("colspan"), 10) || 1, i = parseInt(n.attr("rowspan"), 10) || 1, a = s; a < s + i; a++) for (var o = l; o < l + r; o++) d[a] || (d[a] = []), d[a][o] ? l++ : d[a][o] = t;
                    l += r;
                });
            }), d;
        }
        ...
        function N(e) {
            var t = T.$el.find(".fr-selected-cell");
            if (0 < t.length) {
                var n, r = e.length, i = 0, a = e[0].length, o = 0;
                for (n = 0; n < t.length; n++) {
                    var s = R(t[n], e), l = y(s.row, s.col, e);
        ...
        function O(e) {
            var t = N(e), n = Ee(e[t.min_i][t.min_j]), r = Ee(e[t.min_i][t.max_j]), i = Ee(e[t.max_i][t.min_j]);
            return {
                left: n.offset().left,
        ...
        function w(t, n) {
            if (Ee(t).is(n)) L(), Ee(t).addClass("fr-selected-cell"); else {
                x(), T.edit.off();
                var r = S(), i = R(t, r), a = R(n, r), o = function e(t, n, r, i, a) {
                    var o, s, l, d, c = t, f = n, p = r, u = i;
                ...
                for (var s = o.min_i; s <= o.max_i; s++) for (var l = o.min_j; l <= o.max_j; l++) Ee(r[s][l]).addClass("fr-selected-cell");
            }
        }

        function I(e) {
            var t = null, n = Ee(e.target);
            ...
            if (i || T.$tb.is(e.target) || T.$tb.is(Ee(e.target).closest(T.$tb.get(0))) || (0 < Q().length && T.toolbar.enable(), L()), !(1 != e.which || 1 == e.which && T.helpers.isMac() && e.ctrlKey)) {
                ...
                if (b) {
                    ...
                    T.opts.iframe && (t -= T.$iframe.offset().left), A.data("release-position", t), A.removeData("max-left"), A.removeData("max-right"), function () {
                        var e = A.data("origin"), t = A.data("release-position");
                        if (e !== t) {
                            var n = A.data("first"), r = A.data("second"), i = A.data("table"), a = i.outerWidth();
                            if (T.undo.canDo() || T.undo.saveStep(), null !== n && null !== r) {
                                var o, s, l, d = S(i), c = [], f = [], p = [], u = [];
                                ...
                                var g, m = i.parent(), v = a / m.width() * 100,
        ...
        function k(e) {
            if (!0 === i) {
                if (Ee(e.currentTarget).closest("table").is(Z())) {
                    if ("TD" == e.currentTarget.tagName && 0 === T.$el.find("th.fr-selected-cell").length) return void w(r, e.currentTarget);
                    if ("TH" == e.currentTarget.tagName && 0 === T.$el.find("td.fr-selected-cell").length) return void w(r, e.currentTarget);
                }
                x();
            }
        }
        ...
        function F(e, t, n, r) {
            for (var i, a = t; a != T.el && "TD" != a.tagName && "TH" != a.tagName && ("up" == r ? i = a.previousElementSibling : "down" == r && (i = a.nextElementSibling), !i);) a = a.parentNode;
            "TD" == a.tagName || "TH" == a.tagName ? function (e, t) {
                for (var n = e; n && "TABLE" != n.tagName && n.parentNode != T.el;) n = n.parentNode;
        ...
        function K(e, t) {
            var n = Ee(t), r = n.closest("table"), i = r.parent();
            if (t && "TD" != t.tagName && "TH" != t.tagName && (0 < n.closest("td").length ? t = n.closest("td") : 0 < n.closest("th").length && (t = n.closest("th"))), !t || "TD" != t.tagName && "TH" != t.tagName) A && n.get(0) != A.get(0) && n.parent().get(0) != A.get(0) && T.core.sameInstance(A) && B(); else {
                ...
                var a = n.offset().left - 1, o = a + n.outerWidth();
                if (Math.abs(e.pageX - a) <= T.opts.tableResizerOffset || Math.abs(o - e.pageX) <= T.opts.tableResizerOffset) {
                    var s, l, d, c, f, p = S(r), u = R(t, p), h = y(u.row, u.col, p), g = r.offset().top,
                        m = r.outerHeight() - 1;
        ...
        function U(e, t) {
            ...
            var n, r = Ee(t).find("tr:first"), i = e.pageX, a = 0, o = 0;
        ...
        function H(e, t) {
            if (T.$box.find(".fr-line-breaker").is(":visible")) return !1;
            s || q(), T.$box.append(s), s.data("instance", T);
            var n, r = Ee(t), i = e.pageY, a = 0, o = 0;
            ...
            T.opts.tableResizer && (!T.popups.areVisible() || T.popups.areVisible() && T.popups.isVisible("table.edit")) && K(e, t), !T.opts.tableInsertHelper || T.popups.areVisible() || T.$tb.hasClass("fr-inline") && T.$tb.is(":visible") || function (e, t) {
                if (0 === Q().length) {
                    ...
                    if (t && ("HTML" == t.tagName || "BODY" == t.tagName || T.node.isElement(t))) for (n = 1; n <= T.opts.tableInsertHelperOffset; n++) {
                        ...
                        if (r && ("TH" == r.tagName || "TD" == r.tagName || "TABLE" == r.tagName) && (Ee(r).parents(".fr-wrapper").length || T.opts.iframe)) return U(e, Ee(r).closest("table"));
        ...
        function Y(e, t) {
            var n, r = Ee(t[0][e]).outerWidth();
            for (n = 1; n < t.length; n++) r = Math.min(r, Ee(t[n][e]).outerWidth());
            return r;
        }

        function G(e, t, n) {
            var r, i = 0;
            for (r = e; r <= t; r++) i += Y(r, n);
            return i;
        }
        ...
        function V(e) {
            if (1 < Q().length && a && x(), !1 === a && !1 === i && !1 === b) o && clearTimeout(o), T.edit.isDisabled() && !T.popups.isVisible("table.edit") || (o = setTimeout(W, 30, e)); else if (b) {
                ...
                var n = A.data("max-left"), r = A.data("max-right");
        ...
        function q() {
            T.shared.$ti_helper || (T.shared.$ti_helper = Ee('<div class="fr-insert-helper"><a class="fr-floating-btn" role="button" tabIndex="-1" title="' + T.language.translate("Insert") + '"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M22,16.75 L16.75,16.75 L16.75,22 L15.25,22.000 L15.25,16.75 L10,16.75 L10,15.25 L15.25,15.25 L15.25,10 L16.75,10 L16.75,15.25 L22,15.25 L22,16.75 Z"/></svg></a></div>'), T.events.bindClick(T.shared.$ti_helper, "a", function () {
                var e = s.data("selected-cell"), t = s.data("position"), n = s.data("instance") || T;
        ...
        function Z() {
            var e = Q();
            if (e.length) {
                for (var t = e[0]; t && "TABLE" != t.tagName && t.parentNode != T.el;) t = t.parentNode;
        ...
        return {
            _init: function () {
                ...
                if (!T.helpers.isMobile()) {
                    b = i = a = !1, T.events.$on(T.$el, "mousedown", e), T.popups.onShow("image.edit", function () {
                        ...
                        e.shiftKey ? !1 === function (e) {
                            var t = Q();
                            if (0 < t.length) {
                                var n, r, i = S(), a = e.which;
                                1 == t.length ? r = n = t[0] : (n = T.el.querySelector(".fr-cell-fixed"), r = T.el.querySelector(".fr-cell-handler"));
                                var o = R(r, i);
                                if (Ee.FE.KEYCODE.ARROW_RIGHT == a) {
                                    if (o.col < i[0].length - 1) return w(n, i[o.row][o.col + 1]), !1;
                                } else if (Ee.FE.KEYCODE.ARROW_DOWN == a) {
                                    if (o.row < i.length - 1) return w(n, i[o.row + 1][o.col]), !1;
                                } else if (Ee.FE.KEYCODE.ARROW_LEFT == a) {
                                    if (0 < o.col) return w(n, i[o.row][o.col - 1]), !1;
                                } else if (Ee.FE.KEYCODE.ARROW_UP == a && 0 < o.row) return w(n, i[o.row - 1][o.col]), !1;
                            }
                        }(e) && setTimeout(function () {
                            u();
                        }, 0) : function (e) {
                            var t = e.which, n = T.selection.blocks();
                        ...
                        if (0 < t.length) {
                            ...
                            if (1 < t.length && (e.which == Ee.FE.KEYCODE.BACKSPACE || e.which == Ee.FE.KEYCODE.DELETE)) {
                                T.undo.saveStep();
                                for (var n = 0; n < t.length; n++) Ee(t[n]).html("<br>"), n == t.length - 1 && Ee(t[n]).prepend(Ee.FE.MARKERS);
                            ...
                            if (e.altKey && e.which == Ee.FE.KEYCODE.SPACE) {
                                var t, n = T.selection.element();
                                if ("TD" == n.tagName || "TH" == n.tagName ? t = n : 0 < Ee(n).closest("td").length ? t = Ee(n).closest("td").get(0) : 0 < Ee(n).closest("th").length && (t = Ee(n).closest("th").get(0)), t) return e.preventDefault(), w(t, t), u(), !1;
                            }
                        }(e)) return !1;
                    }, !0);
                    var t = [];
            ...
            }, remove: h, insertRow: g, deleteRow: function () {
                var e = Z();
                if (0 < e.length) {
                    var t, n, r, i = S(), a = N(i);
                    if (0 === a.min_i && a.max_i == i.length - 1) h(); else {
                        for (t = a.max_i; t >= a.min_i; t--) {
                            for (r = Ee(e.find("tr").not(e.find("table tr")).get(t)), n = 0; n < i[t].length; n++) if (0 === n || i[t][n] != i[t][n - 1]) {
                                var o = Ee(i[t][n]);
                ...
                if (0 < e.length) {
                    ...
                    var n, f = 100 / c[0].length, p = 100 / (c[0].length + 1);
                ...
                if (0 < e.length) {
                    ...
                    if (0 === a.min_j && a.max_j == i[0].length - 1) h(); else {
                        var o = 0;
                        for (t = 0; t < i.length; t++) for (n = 0; n < i[0].length; n++) (r = Ee(i[t][n])).hasClass("fr-selected-cell") || (r.data("old-width", r.outerWidth() / e.outerWidth() * 100), (n < a.min_j || n > a.max_j) && (o += r.outerWidth() / e.outerWidth() * 100));
                        for (o /= i.length, n = a.max_j; n >= a.min_j; n--) for (t = 0; t < i.length; t++) if (0 === t || i[t][n] != i[t - 1][n]) if (r = Ee(i[t][n]), 1 < (parseInt(r.attr("colspan"), 10) || 1)) {
                ...
                if (1 < Q().length && (0 === T.$el.find("th.fr-selected-cell").length || 0 === T.$el.find("td.fr-selected-cell").length)) {
                    _();
                    var e, t, n = N(S()), r = T.$el.find(".fr-selected-cell"), i = Ee(r[0]),
                        a = i.parent().find(".fr-selected-cell"), o = i.closest("table"), s = i.html(), l = 0;
                ...
                if (1 == Q().length) {
                    var e = T.$el.find(".fr-selected-cell"), t = parseInt(e.attr("colspan"), 10) || 1,
                        n = e.parent().outerWidth(), r = e.outerWidth(), i = e.clone().html("<br>"), a = S(),
                        o = R(e.get(0), a);
                    if (1 < t) {
                        var s = Math.ceil(t / 2);
                        ...
                        var d;
                        for (d = 0; d < a.length; d++) if (0 === d || a[d][o.col] != a[d - 1][o.col]) {
                            var c = Ee(a[d][o.col]);
                            if (!c.is(e)) {
                ...
                if (1 == Q().length) {
                    var e = T.$el.find(".fr-selected-cell"), t = e.parent(), n = e.closest("table"),
                        r = parseInt(e.attr("rowspan"), 10), i = S(), a = R(e.get(0), i), o = e.clone().html("<br>");
                    if (1 < r) {
                        var s = Math.ceil(r / 2);
                        1 < s ? e.attr("rowspan", s) : e.removeAttr("rowspan"), 1 < r - s ? o.attr("rowspan", r - s) : o.removeAttr("rowspan");
                        for (var l = a.row + s, d = 0 === a.col ? a.col : a.col - 1; 0 <= d && (i[l][d] == i[l][d - 1] || 0 < l && i[l][d] == i[l - 1][d]);) d--;
                        -1 == d ? Ee(n.find("tr").not(n.find("table tr")).get(l)).prepend(o) : Ee(i[l][d]).after(o);
                    } else {
                        var c, f = Ee("<tr>").append(o);
                        for (c = 0; c < i[0].length; c++) if (0 === c || i[a.row][c] != i[a.row][c - 1]) {
                            var p = Ee(i[a.row][c]);
                ...
                var e = T.$tb.find('.fr-command[data-cmd="insertTable"]'), t = T.popups.get("table.insert");
            ...
            }, showEditPopup: u, showColorsPopup: d, back: function () {
            ...
            }, selectedTable: Z, selectedCells: Q, customColor: function () {
                var e = T.popups.get("table.colors").find(".fr-table-colors-hex-layer input");
                e.length && t(e.val());
            }
        };
    }, Ee.FE.DefineIcon("insertTable", {NAME: "table"}), Ee.FE.RegisterCommand("insertTable", {
        title: "Insert Table",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Ee.FE.COMMANDS.tableRows.options;
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Ee.FE.COMMANDS.tableColumns.options;
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Ee.FE.COMMANDS.tableCells.options;
    ...
    }), Ee.FE.DefineIcon("tableRemove", {NAME: "trash"}), Ee.FE.RegisterCommand("tableRemove", {
        title: "Remove Table",
        focus: !1,
        callback: function () {
            this.table.remove();
        }
    }), Ee.FE.DefineIcon("tableStyle", {NAME: "paint-brush"}), Ee.FE.RegisterCommand("tableStyle", {
        title: "Table Style",
        type: "dropdown",
        focus: !1,
        html: function () {
    ...
    }), Ee.FE.DefineIcon("tableCellBackground", {NAME: "tint"}), Ee.FE.RegisterCommand("tableCellBackground", {
    ...
    }), Ee.FE.DefineIcon("tableBack", {NAME: "arrow-left"}), Ee.FE.RegisterCommand("tableBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }),Ee.FE.DefineIcon("tableColorRemove", {NAME: "eraser"}),Ee.FE.URLRegEx = "(^| |\\u00A0)(" + Ee.FE.LinkRegEx + "|([a-z0-9+-_.]{1,}@[a-z0-9+-_.]{1,}\\.[a-z0-9+-_]{1,}))$",Ee.FE.PLUGINS.url = function (a) {
        var o = null;
        ...
        function s(e) {
            return a.opts.linkAlwaysNoFollow && (o = "nofollow"), a.opts.linkAlwaysBlank && (a.opts.linkNoOpener && (o ? o += " noopener" : o = "noopener"), a.opts.linkNoReferrer && (o ? o += " noreferrer" : o = "noreferrer")), e.replace(i(), t);
        }
        ...
        html: '<iframe width="640" height="360" src="{url}" frameborder="0" allowfullscreen></iframe>',
        provider: "vidyard"
    }],Ee.FE.VIDEO_EMBED_REGEX = /^\W*((<iframe.*><\/iframe>)|(<embed.*>))\W*$/i,Ee.FE.PLUGINS.video = function (f) {
        var s, c, p, u, r, n, l = 2, d = 3, h = 4, g = 5, m = 6, i = {};
        ...
        function a() {
            ...
            if (e || (e = function () {
                ...
                if (0 < f.opts.videoEditButtons.length) {
                    ...
                    var t = {buttons: e += "</div>"}, n = f.popups.create("video.edit", t);
                    return f.events.$on(f.$wp, "scroll.video-edit", function () {
                        u && f.popups.isVisible("video.edit") && (f.events.disableBlur(), R(u));
                    }), n;
                }
                return !1;
            }()), e) {
                f.popups.setContainer("video.edit", f.$sc), f.popups.refresh("video.edit");
                var t = u.find("iframe, embed, video"), n = t.offset().left + t.outerWidth() / 2,
        ...
        function o(e) {
            ...
            var n, r = "", i = f.opts.videoInsertButtons.indexOf("videoUpload"),
            ...
            return function (r) {
                f.events.$on(r, "dragover dragenter", ".fr-video-upload-layer", function () {
                    return Ee(this).addClass("fr-drop"), !1;
                }, !0), f.events.$on(r, "dragleave dragend", ".fr-video-upload-layer", function () {
                    return Ee(this).removeClass("fr-drop"), !1;
                }, !0), f.events.$on(r, "drop", ".fr-video-upload-layer", function (e) {
                    e.preventDefault(), e.stopPropagation(), Ee(this).removeClass("fr-drop");
                    var t = e.originalEvent.dataTransfer;
                    if (t && t.files) {
                ...
                }, !0), f.helpers.isIOS() && f.events.$on(r, "touchstart", '.fr-video-upload-layer input[type="file"]', function () {
                    Ee(this).trigger("click");
                }, !0);
        ...
        function T(s, e, l, d, c) {
            ...
            A("Loading video"), function () {
                var e, t;
                if (d) {
                    f.undo.canDo() || d.find("video").hasClass("fr-uploading") || f.undo.saveStep();
                    var n = d.find("video").data("fr-old-src"), r = d.data("fr-replaced");
                    ...
                    if (void 0 !== l) for (t in l) l.hasOwnProperty(t) && "link" != t && e.find("video").attr("data-" + t, l[t]);
        ...
        function y(e) {
            ...
            var t = this.status, n = this.response, r = this.responseXML, i = this.responseText;
            try {
                if (f.opts.videoUploadToS3) if (201 == t) {
                    var a = function (e) {
                        try {
                            var t = Ee(e).find("Location").text(), n = Ee(e).find("Key").text();
                    ...
                    a && T(a, !1, [], e, n || r);
                } else K(h, n || r); else if (200 <= t && t < 300) {
                    var o = function (e) {
                        try {
                            if (!1 === f.events.trigger("video.uploaded", [e], !0)) return f.edit.on(), !1;
                            var t = JSON.parse(e);
        ...
        function _() {
            K(h, this.response || this.responseText || this.responseXML);
        }
        ...
        function N(e) {
            ...
            if (!t || !n) return !1;
            if ("mousedown" == e.type) {
                var r = f.$oel.get(0).ownerDocument, i = r.defaultView || r.parentWindow, a = !1;
                try {
        ...
        function O(e) {
            ...
            if (c) {
                ...
                var t = e.pageX || (e.originalEvent.touches ? e.originalEvent.touches[0].pageX : null),
                    n = e.pageY || (e.originalEvent.touches ? e.originalEvent.touches[0].pageY : null);
                if (!t || !n) return !1;
                var r = c.data("start-x"), i = c.data("start-y");
                c.data("start-x", t), c.data("start-y", n);
                var a = t - r, o = n - i, s = u.find("iframe, embed, video"), l = s.width(), d = s.height();
        ...
        function I(e, t, n, r) {
            return e.pageX = t, e.pageY = t, N.call(this, e), e.pageX = e.pageX + n * Math.floor(Math.pow(1.1, r)), e.pageY = e.pageY + n * Math.floor(Math.pow(1.1, r)), O.call(this, e), w.call(this, e), ++r;
        }

        function D() {
            var e, t = Array.prototype.slice.call(f.el.querySelectorAll("video, .fr-video > *")), n = [];
            ...
            if (r) for (e = 0; e < r.length; e++) n.indexOf(r[e].getAttribute("src")) < 0 && f.events.trigger("video.removed", [Ee(r[e])]);
            r = t;
        }
        ...
        function k() {
            p || function () {
                var e;
                if (f.shared.$video_resizer ? (p = f.shared.$video_resizer, s = f.shared.$vid_overlay, f.events.on("destroy", function () {
                    p.removeClass("fr-active").appendTo(Ee("body:first"));
                }, !0)) : (f.shared.$video_resizer = Ee('<div class="fr-video-resizer"></div>'), p = f.shared.$video_resizer, f.events.$on(p, "mousedown", function (e) {
                    e.stopPropagation();
                }, !0), f.opts.videoResize && (p.append(t("nw") + t("ne") + t("sw") + t("se")), f.shared.$vid_overlay = Ee('<div class="fr-video-overlay"></div>'), s = f.shared.$vid_overlay, e = p.get(0).ownerDocument, Ee(e).find("body:first").append(s))), f.events.on("shared.destroy", function () {
                    p.html("").removeData().remove(), p = null, f.opts.videoResize && (s.remove(), s = null);
                }, !0), f.helpers.isMobile() || f.events.$on(Ee(f.o_win), "resize.video", function () {
                    M(!0);
                }), f.opts.videoResize) {
        ...
        function M(e) {
            u && (f.shared.vid_exit_flag || !0 === e) && (p.removeClass("fr-active"), f.toolbar.enable(), u.removeClass("fr-active"), u = null, $());
        }

        function e() {
            f.shared.vid_exit_flag = !0;
        }

        function $() {
            f.shared.vid_exit_flag = !1;
        }
        ...
        function P(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if (f.drag_support.formdata && (t = f.drag_support.formdata ? new FormData : null), t) {
                    ...
                    a.onload = function () {
                        y.call(a, u);
                    }, a.onerror = _, a.upload.onprogress = L, a.onabort = x, A(), f.events.disableBlur(), f.edit.off(), f.events.enableBlur();
        ...
        function K(e, t) {
            f.edit.on(), u && u.find("video").addClass("fr-error"), function (e) {
                A();
                var t = f.popups.get("video.insert").find(".fr-video-progress-bar-layer");
                t.addClass("fr-error");
                var n = t.find("h3");
                n.text(e), f.events.disableBlur(), n.focus();
            }(f.language.translate("Something went wrong. Please try again.")), f.events.trigger("video.error", [{
                code: e,
                message: i[e]
            }, t]);
        }
        ...
        function U() {
            if (u) {
                var e = f.popups.get("video.size"), t = u.find("iframe, embed, video");
        ...
        function H(e) {
            ...
            var t = {
                buttons: '<div class="fr-buttons">' + f.button.buildList(f.opts.videoSizeButtons) + "</div>",
                size_layer: '<div class="fr-video-size-layer fr-layer fr-active" id="fr-video-size-layer-' + f.id + '"><div class="fr-video-group"><div class="fr-input-line"><input id="fr-video-size-layer-width-' + f.id + '" type="text" name="width" placeholder="' + f.language.translate("Width") + '" tabIndex="1"></div><div class="fr-input-line"><input id="fr-video-size-layer-height-' + f.id + '" type="text" name="height" placeholder="' + f.language.translate("Height") + '" tabIndex="1"></div></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-submit" data-cmd="videoSetSize" tabIndex="2" role="button">' + f.language.translate("Update") + "</button></div></div>"
            }, n = f.popups.create("video.size", t);
            return f.events.$on(f.$wp, "scroll", function () {
                u && f.popups.isVisible("video.size") && (f.events.disableBlur(), R(u));
            }), n;
        }
        ...
        function V(e, t, n) {
            !f.opts.htmlUntouched && f.opts.useClasses ? (e.removeClass("fr-fvl fr-fvr fr-dvb fr-dvi"), e.addClass("fr-fv" + n[0] + " fr-dv" + t[0])) : "inline" == t ? (e.css({display: "inline-block"}), "center" == n ? e.css({"float": "none"}) : "left" == n ? e.css({"float": "left"}) : e.css({"float": "right"})) : (e.css({
                display: "block",
                clear: "both"
        ...
        function X() {
            f.$el.find("video").filter(function () {
                return 0 === Ee(this).parents("span.fr-video").length;
            }).wrap('<span class="fr-video" contenteditable="false"></span>'), f.$el.find("embed, iframe").filter(function () {
                if (f.browser.safari && this.getAttribute("src") && this.setAttribute("src", this.src), 0 < Ee(this).parents("span.fr-video").length) return !1;
                for (var e = Ee(this).attr("src"), t = 0; t < Ee.FE.VIDEO_PROVIDERS.length; t++) {
                    var n = Ee.FE.VIDEO_PROVIDERS[t];
                    if (n.test_regex.test(e) && new RegExp(f.opts.videoAllowedProviders.join("|")).test(n.provider)) return !0;
                }
                return !1;
            }).map(function () {
            ...
            for (var e, t, n = f.$el.find("span.fr-video, video"), r = 0; r < n.length; r++) {
                var i = Ee(n[r]);
                !f.opts.htmlUntouched && f.opts.useClasses ? ((t = i).hasClass("fr-dvi") || t.hasClass("fr-dvb") || (t.addClass("fr-fv" + W(t)[0]), t.addClass("fr-dv" + z(t)[0])), f.opts.videoTextNear || i.removeClass("fr-dvi").addClass("fr-dvb")) : f.opts.htmlUntouched || f.opts.useClasses || (V(e = i, e.hasClass("fr-dvb") ? "block" : e.hasClass("fr-dvi") ? "inline" : null, e.hasClass("fr-fvl") ? "left" : e.hasClass("fr-fvr") ? "right" : W(e)), e.removeClass("fr-dvb fr-dvi fr-fvr fr-fvl"));
            }
        ...
        return i[1] = "Video cannot be loaded from the passed link.", i[l] = "No link in upload response.", i[d] = "Error during file upload.", i[h] = "Parsing response failed.", i[g] = "File is too large.", i[m] = "Video file type is invalid.", i[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", f.shared.vid_exit_flag = !1, {
            _init: function () {
                f.events.on("drop", B, !0), f.events.on("mousedown window.mousedown", e), f.events.on("window.touchmove", $), f.events.on("mouseup window.mouseup", M), f.events.on("commands.mousedown", function (e) {
                    0 < e.parents(".fr-toolbar").length && M();
                }), f.events.on("video.hideResizer commands.undo commands.redo element.dropped", function () {
                    M(!0);
                }), f.helpers.isMobile() && (f.events.$on(f.$el, "touchstart", "span.fr-video", function () {
                    n = !1;
                }), f.events.$on(f.$el, "touchmove", function () {
                    n = !0;
                })), f.events.on("html.set", X), X(), f.events.$on(f.$el, "mousedown", "span.fr-video", function (e) {
                    e.stopPropagation();
                }), f.events.$on(f.$el, "click touchend", "span.fr-video", function (e) {
                    if ("false" == Ee(this).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable")) return !0;
                    F.call(this, e);
                }), f.events.on("keydown", function (e) {
                    var t = e.which;
                    return !u || t != Ee.FE.KEYCODE.BACKSPACE && t != Ee.FE.KEYCODE.DELETE ? u && t == Ee.FE.KEYCODE.ESC ? (M(!0), e.preventDefault(), !1) : u && t != Ee.FE.KEYCODE.F10 && !f.keys.isBrowserAction(e) ? (e.preventDefault(), !1) : void 0 : (e.preventDefault(), Y(), f.undo.saveStep(), !1);
                }, !0), f.events.on("toolbar.esc", function () {
                    if (u) return f.events.disableBlur(), f.events.focus(), !1;
                }, !0), f.events.on("toolbar.focusEditor", function () {
                    if (u) return !1;
                }, !0), f.events.on("keydown", function () {
                    f.$el.find("span.fr-video:empty").remove();
                }), f.$wp && (D(), f.events.on("contentChanged", D)), o(!0), H(!0);
            }, showInsertPopup: function () {
                var e = f.$tb.find('.fr-command[data-cmd="insertVideo"]'), t = f.popups.get("video.insert");
                if (t || (t = o()), C(), !t.hasClass("fr-active")) if (f.popups.refresh("video.insert"), f.popups.setContainer("video.insert", f.$tb), e.is(":visible")) {
                    var n = e.offset().left + e.outerWidth() / 2,
                        r = e.offset().top + (f.opts.toolbarBottom ? 10 : e.outerHeight() - 10);
                ...
                f.popups.get("video.insert").find(".fr-video-by-url-layer").hasClass("fr-active") && e.addClass("fr-active").attr("aria-pressed", !0);
            }, refreshEmbedButton: function (e) {
                f.popups.get("video.insert").find(".fr-video-embed-layer").hasClass("fr-active") && e.addClass("fr-active").attr("aria-pressed", !0);
            }, refreshUploadButton: function (e) {
                f.popups.get("video.insert").find(".fr-video-upload-layer").hasClass("fr-active") && e.addClass("fr-active").attr("aria-pressed", !0);
            }, upload: P, insertByURL: function (e) {
                void 0 === e && (e = (f.popups.get("video.insert").find('.fr-video-by-url-layer input[type="text"]').val() || "").trim());
                var t = null;
                if (/^http/.test(e) || (e = "https://" + e), f.helpers.isURL(e)) for (var n = 0; n < Ee.FE.VIDEO_PROVIDERS.length; n++) {
                    var r = Ee.FE.VIDEO_PROVIDERS[n];
                    if (r.test_regex.test(e) && new RegExp(f.opts.videoAllowedProviders.join("|")).test(r.provider)) {
                ...
                void 0 === e && (e = f.popups.get("video.insert").find(".fr-video-embed-layer textarea").val() || ""), 0 !== e.length && Ee.FE.VIDEO_EMBED_REGEX.test(e) ? E(e) : f.events.trigger("video.codeError", [e]);
            }, insert: E, align: function (e) {
                u.removeClass("fr-fvr fr-fvl"), !f.opts.htmlUntouched && f.opts.useClasses ? "left" == e ? u.addClass("fr-fvl") : "right" == e && u.addClass("fr-fvr") : V(u, z(), e), q(), k(), a(), f.selection.clear();
            }, refreshAlign: function (e) {
                if (!u) return !1;
                e.find("> *:first").replaceWith(f.icon.create("video-align-" + W()));
            }, refreshAlignOnShow: function (e, t) {
                u && t.find('.fr-command[data-param1="' + W() + '"]').addClass("fr-active").attr("aria-selected", !0);
            }, display: function (e) {
                u.removeClass("fr-dvi fr-dvb"), !f.opts.htmlUntouched && f.opts.useClasses ? "inline" == e ? u.addClass("fr-dvi") : "block" == e && u.addClass("fr-dvb") : V(u, e, W()), q(), k(), a(), f.selection.clear();
            }, refreshDisplayOnShow: function (e, t) {
                u && t.find('.fr-command[data-param1="' + z() + '"]').addClass("fr-active").attr("aria-selected", !0);
            }, remove: Y, hideProgressBar: C, showSizePopup: function () {
                var e = f.popups.get("video.size");
                e || (e = H()), C(), f.popups.refresh("video.size"), f.popups.setContainer("video.size", f.$sc);
                var t = u.find("iframe, embed, video"), n = t.offset().left + t.width() / 2,
                ...
                var t = u.offset().left + u.width() / 2, n = u.offset().top + u.height();
                f.popups.show("video.insert", t, n, u.outerHeight());
            }, back: function () {
                u ? (f.events.disableBlur(), u.trigger("click")) : (f.events.disableBlur(), f.selection.restore(), f.events.enableBlur(), f.popups.hide("video.insert"), f.toolbar.showInline());
            }, setSize: function (e, t) {
                if (u) {
                    var n = f.popups.get("video.size"), r = u.find("iframe, embed, video");
        ...
        NAME: "video-camera",
        FA5NAME: "camera"
    }),Ee.FE.DefineIcon("videoByURL", {NAME: "link"}),Ee.FE.RegisterCommand("videoByURL", {
        title: "By URL",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }),Ee.FE.DefineIcon("videoEmbed", {NAME: "code"}),Ee.FE.RegisterCommand("videoEmbed", {
        title: "Embedded Code",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }),Ee.FE.DefineIcon("videoUpload", {NAME: "upload"}),Ee.FE.RegisterCommand("videoUpload", {
        title: "Upload Video",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }),Ee.FE.DefineIcon("videoDisplay", {NAME: "star"}),Ee.FE.RegisterCommand("videoDisplay", {
        title: "Display",
        type: "dropdown",
        options: {inline: "Inline", block: "Break Text"},
        callback: function (e, t) {
    ...
    }),Ee.FE.DefineIcon("video-align", {NAME: "align-left"}),Ee.FE.DefineIcon("video-align-left", {NAME: "align-left"}),Ee.FE.DefineIcon("video-align-right", {NAME: "align-right"}),Ee.FE.DefineIcon("video-align-center", {NAME: "align-justify"}),Ee.FE.DefineIcon("videoAlign", {NAME: "align-center"}),Ee.FE.RegisterCommand("videoAlign", {
        type: "dropdown",
        title: "Align",
        options: {left: "Align Left", center: "None", right: "Align Right"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Ee.FE.COMMANDS.videoAlign.options;
    ...
    }),Ee.FE.DefineIcon("videoReplace", {NAME: "exchange"}),Ee.FE.RegisterCommand("videoReplace", {
        title: "Replace",
        undo: !1,
        focus: !1,
        popup: !0,
    ...
    }),Ee.FE.DefineIcon("videoRemove", {NAME: "trash"}),Ee.FE.RegisterCommand("videoRemove", {
        title: "Remove",
        callback: function () {
            this.video.remove();
        }
    }),Ee.FE.DefineIcon("videoSize", {NAME: "arrows-alt"}),Ee.FE.RegisterCommand("videoSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
    ...
    }),Ee.FE.DefineIcon("videoBack", {NAME: "arrow-left"}),Ee.FE.RegisterCommand("videoBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        function t(e) {
            ...
            e || (T.opts.wordAllowedStyleProps = []), 0 === r.indexOf("<colgroup>") && (r = "<table>" + r + "</table>"), r = function (e, t) {
                ...
                var n = (new DOMParser).parseFromString(e, "text/html"), r = n.head, i = n.body, o = function (e) {
                    var t = {}, n = e.getElementsByTagName("style");
                    if (n.length) {
                        var r = n[0], i = r.innerHTML.match(/[\S ]+\s+{[\s\S]+?}/gi);
                        if (i) for (var a = 0; a < i.length; a++) {
                            var o = i[a], s = o.replace(/([\S ]+\s+){[\s\S]+?}/gi, "$1"),
                    ...
                    return e.nodeType != Node.ELEMENT_NODE || "V:IMAGEDATA" != e.tagName && "IMG" != e.tagName || function (e, t) {
                        ...
                        if (a) {
                            var o = function (e) {
                                ...
                                var i = n.join("");
                                return btoa(i);
                            }(a.image_hex), s = "data:" + a.image_type + ";base64," + o;
                ...
                c(i, function (t) {
                    ...
                    if (t.nodeType == Node.ELEMENT_NODE) {
                        if (C(t)) {
                            var n = t.parentNode, r = t.previousSibling, i = function e(t, n) {
                                var r = /[0-9a-zA-Z]./gi;
                                var i = !1;
                                ...
                                t = null;
                                for (; l && C(l);) {
                                    var c = l.previousElementSibling, f = g(l);
                                    if (o < f) s += e(l, n).outerHTML; else {
                                        if (f < o) break;
                                        s += "</li><li>" + m(l, n);
                                    }
                    ...
                    if (e.nodeType == Node.ELEMENT_NODE) {
                        ...
                        if (!e.innerHTML && -1 == ["BR", "IMG"].indexOf(t)) {
                            for (var n = e.parentNode; n && (A(e), !(e = n).innerHTML);) n = e.parentNode;
                            return !1;
                        }
                        !function (e) {
                ...
                var l = i.outerHTML, d = T.opts.htmlAllowedStyleProps;
        ...
        function p(e, t) {
            var n = e.tagName, r = n.toLowerCase();
            ...
            var i = -1, a = ["META", "LINK", "XML", "ST1:", "O:", "W:", "FONT"];
            for (i = 0; i < a.length; i++) if (-1 != n.indexOf(a[i])) return e.innerHTML && (e.outerHTML = e.innerHTML), A(e), !1;
            if ("TD" != n) {
                    ...
                    return r = e, T.opts.wordPasteModal ? function () {
                        if (!a) {
                            var e = '<h4><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 74.95 73.23" style="height: 25px; vertical-align: text-bottom; margin-right: 5px; display: inline-block"><defs><style>.a{fill:#2a5699;}.b{fill:#fff;}</style></defs><path class="a" d="M615.15,827.22h5.09V834c9.11.05,18.21-.09,27.32.05a2.93,2.93,0,0,1,3.29,3.25c.14,16.77,0,33.56.09,50.33-.09,1.72.17,3.63-.83,5.15-1.24.89-2.85.78-4.3.84-8.52,0-17,0-25.56,0v6.81h-5.32c-13-2.37-26-4.54-38.94-6.81q0-29.8,0-59.59c13.05-2.28,26.11-4.5,39.17-6.83Z" transform="translate(-575.97 -827.22)"/><path class="b" d="M620.24,836.59h28.1v54.49h-28.1v-6.81h22.14v-3.41H620.24v-4.26h22.14V873.2H620.24v-4.26h22.14v-3.41H620.24v-4.26h22.14v-3.41H620.24v-4.26h22.14v-3.41H620.24V846h22.14v-3.41H620.24Zm-26.67,15c1.62-.09,3.24-.16,4.85-.25,1.13,5.75,2.29,11.49,3.52,17.21,1-5.91,2-11.8,3.06-17.7,1.7-.06,3.41-.15,5.1-.26-1.92,8.25-3.61,16.57-5.71,24.77-1.42.74-3.55,0-5.24.09-1.13-5.64-2.45-11.24-3.47-16.9-1,5.5-2.29,10.95-3.43,16.42q-2.45-.13-4.92-.3c-1.41-7.49-3.07-14.93-4.39-22.44l4.38-.18c.88,5.42,1.87,10.82,2.64,16.25,1.2-5.57,2.43-11.14,3.62-16.71Z" transform="translate(-575.97 -827.22)"/></svg> ' + T.language.translate("Word Paste Detected") + "</h4>",
                                ...
                                n = T.modals.create(o, e, t), r = n.$body;
