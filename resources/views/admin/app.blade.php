		...
		<div class="container-fluid">
			<div class="d-flex justify-content-between">
				...
				<div class="top-menu d-flex align-items-center">
					...
					<router-link :to="{name: 'profile.index', params: {}}" class="nav-link ml-2" title="Profile">
						<i class="ik ik-user"></i>
					</router-link>

					<a class="nav-link ml-2" title="Logout" href="#" @click.prevent="logout"><i
								class="ik ik-power text-danger"></i></a>
	...
	<div class="page-wrap">
		<div class="app-sidebar colored">
			<div class="sidebar-header">
				<a class="header-brand" href="{{ url('/') }}">
					<div class="logo-img">
						<img src="/images/logo.png" class="header-brand-img" alt="{{ config('app.name') }}">
					</div>{{--
			...
			<div class="sidebar-content">
				<div class="nav-container">
					<nav id="main-menu-navigation" class="navigation-main">
						...
						<router-link :to="{name: 'home'}" class="nav-item" tag="div" exact>
							<a><i class="ik ik-bar-chart-2"></i><span>Dashboard</span></a>
						</router-link>


						@canany(['roles.read', 'users.read'])

							<div class="nav-item has-sub"
								 :class="{open: isRouteMatchesAny(['users.index', 'users.create','users.edit', 'roles.index', 'roles.create', 'roles.edit'])}">
								<a><i class="ik ik-users"></i><span>Users</span></a>

								<div class="submenu-content">

									@can('users.read')
										<router-link :to="{name: 'users.index', params: {}}" class="menu-item">
											All Users
										</router-link>
									@endcan

									@can('roles.read')
										<router-link :to="{name: 'roles.index', params: {}}" class="menu-item">
											Roles
										</router-link>
									@endcan
								</div>
						...
						@canany(['project-categories.read', 'projects.read'])
							...
							<div class="nav-item has-sub"
								...
								<div class="submenu-content">
									@can('projects.read')
										<router-link :to="{name: 'projects.index', params: {}}" class="menu-item" exact>
											All Projects
										</router-link>
									@endcan
									@can('project-categories.read')
										<router-link :to="{name: 'project-categories.index', params: {}}"
													 class="menu-item"
													 exact>
											Project Categories
										</router-link>
						...
						@endcanany
						{{--
						<router-link :to="{name: 'projects.index', params: {}}" class="nav-item has-sub" tag="div" @click.prevent=""
									 exact-active-class="open" active-class="open">
							<a><i class="ik ik-layers"></i><span>Projects</span> <span
							...
							<div class="submenu-content">
								...
								<router-link :to="{name: 'project-categories.index', params: {}}" class="menu-item" exact>
									Project Categories
								</router-link>
							</div>

						</router-link>--}}
						{{--<router-link :to="{name: 'projects.index'}" class="nav-item" tag="div" exact>
							<a><i class="ik ik-activity"></i><span>Projects</span></a>
						</router-link>

						<router-link :to="{name: 'project-categories.index'}" class="nav-item" tag="div" exact>
							<a><i class="ik ik-list"></i><span>Project Categories</span></a>
						</router-link>--}}
						{{--

												@can('settings.update')
													<router-link :to="{name: 'settings.index'}" class="nav-item" tag="div" exact>
														<a><i class="ik ik-settings"></i><span>Settings</span></a>
													</router-link>
												@endcan
						--}}
						...
						{{--<div class="nav-item has-sub">
							<a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Projects</span> <span
										class="badge badge-danger">150+</span></a>
							<div class="submenu-content">
								<router-link :to="{name: 'projects.index', params: {}}" class="menu-item" exact>
									All Projects
								</router-link>
								<router-link :to="{name: 'project-categories.index', params: {}}" class="menu-item">
									Project Categories
								</router-link>
							</div>
						</div>--}}
		...
		<div class="main-content">
			<div class="container-fluid">
							...
							<div class="list-item">
								<div class="item-inner">
									...
									<div class="list-title"><a href="javascript:void(0)">Donec lectus augue, suscipit in
											sodales sit amet, semper sit amet enim. Duis pretium, nisi id pretium
											ornare, tortor nibh sodales tellus.</a></div>
									<div class="list-actions">
										<a href="#"><i class="ik ik-eye"></i></a>
										<a href="#"><i class="ik ik-inbox"></i></a>
										<a href="#"><i class="ik ik-edit-2"></i></a>
				...
				<router-view :permissions="{{ json_encode(get_permissions(auth()->user())) }}"
							 user-name="{{ auth()->user()->name }}"></router-view>
		...
		<footer class="footer">
			<div class="w-100 clearfix">
				<span class="text-center text-sm-left d-md-inline-block">Copyright © 2018 {{ config('app.name') }}. All Rights Reserved.</span>
				<span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Crafted with <i
							class="fa fa-heart text-danger"></i> by <a href="http://www.phonixit.com/" class="text-dark"
																	   target="_blank">PhonixIT</a></span>
			</div>
		</footer>
...
<script>window.jQuery || document.write('<script src="/admin/js/vendor/jquery-3.3.1.min.js"><\/script>');</script>
