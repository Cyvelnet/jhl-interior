...
<head>
    <meta charset="utf-8">
    <title>JHL NAJU</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="JHL MAJU SDN BHD was managed by a group of qualified, enthusiatic and experienced individuals. The main business activities were interior design, construction & renovation and technological services.">
    <meta name="keywords" content="architecture,building,business,garden design,house,interior design,landscape design,property,studio,security system,cleaning,services maintanance">
                        ...
                        <nav>
                            <ul id="mainmenu">
								...
								<li><a href="/services">Our Services</a>
									<ul>
										<li><a href="/nature">NATURE OF BUSINESS</a></li>
...
was managed by a group of qualified, enthusiatic and experienced individuals. During the early set-up of the company, the main business activities were interior design, construction & renovation and technological services. We have since started to offer technical assistance in concept and branding operation and maintenance services.
                        </div>
                    </div>
                </div>
